...
mod.RoomData.Surface = mod.RoomData.Surface or {
	BaseSurface = {
		UnthreadedEvents = {},
				...
				InteractTextLineSets = {
					Inspect_E_Intro_01_01 = {
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}The surface, wind-swept, wracked by freezing cold, nonetheless instills within the prince a sense of awe, and the sublime. For it is unlike anything that he has seen."
						},
					},
				},
			},
				...
				InteractTextLineSets = {
					Inspect_E_Intro_01_01 = {
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}All manner of fruits and vegetables thrive within the hidden gardens of Persephone, the one-time Queen of all the Underworld. A world of life, far from the realm of death."
						},
					},
				},
			},
