...
mod.GlobalVoiceLines = mod.GlobalVoiceLines or {
	...
	ThanatosGreetingVoiceLines = {
		...
		-- Hey Zag.
		-- { Cue = "/VO/Thanatos_0426", RequiredAnyTextLines = { "BecameCloseWithThanatos01", "BecameCloseWithThanatos01_B" }, RequiredPlayed = { "/VO/Thanatos_0183" } },
		-- Hey.
		...
		-- Glad you're back.
		{ Cue = "/VO/Thanatos_0434", RequiredAnyTextLines = { "BecameCloseWithThanatos01", "BecameCloseWithThanatos01_B" }, RequiredPlayed = { "/VO/Thanatos_0183" } },
		-- Back in one piece.
		...
		-- What's going on, Zag.
		-- { Cue = "/VO/Thanatos_0438", RequiredAnyTextLines = { "BecameCloseWithThanatos01", "BecameCloseWithThanatos01_B" }, RequiredPlayed = { "/VO/Thanatos_0183" } },
	},
...
mod.HeroVoiceLines = mod.HeroVoiceLines or {
	...
	ModsNikkelMHadesBiomes_UsedLyreVoiceLines = {
		...
		},
		{
			...
			Cooldowns = {
				{ Name = "MelinoeLyrePlaying", Time = 12 },
			},
