...
mod.HeroVoiceLines = mod.HeroVoiceLines or {
	...
	ModsNikkelMHadesBiomes_EnteredDeathAreaVoiceLines = {
		...
		-- Cleared Modded Run
		{
			...
			{ Cue = "/VO/Melinoe_5150", Text = "{#Emph}<Sigh> {#Prev}Properly done.", RequiredTrueTextLines = { "Ending01", }, },
			{ Cue = "/VO/Melinoe_5151", Text = "{#Emph}<Sigh> {#Prev}One more then?" },
			{ Cue = "/VO/Melinoe_5152", Text = "{#Emph}<Sigh> {#Prev}That was good.", RequiredTrueTextLines = { "Ending01", }, },
			{
				Cue = "/VO/Melinoe_5154",
