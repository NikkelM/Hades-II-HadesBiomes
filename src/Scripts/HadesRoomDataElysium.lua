				...
				InteractTextLineSets =
				{
					Inspect_C_PreBoss_01_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}The magnificently ominous facade of the great Elysian Stadium looms tall above the rabble-rousing Prince, as if to goad him into such a competition which he cannot hope to win."
						},
					},
				},
			},
				...
				DistanceTriggers =
				{
					...
					},
					{
						...
						VoiceLines =
						{
							...
							{
								Cue = "/VO/ZagreusField_3024",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.5, Groups = { "SupportiveShade" }, }
							},
							-- I dedicate this victory to you, good Shade!
							{
								Cue = "/VO/ZagreusField_3025",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.5, Groups = { "SupportiveShade" }, }
							},
							...
							-- Hello, supportive Shade!
							{
								...
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.25, Groups = { "SupportiveShade" }, }
							},
							-- I won again, Shade, thanks to your support!
							{
								Cue = "/VO/ZagreusField_3028",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.5, Groups = { "SupportiveShade" }, }
							},
							...
							{
								Cue = "/VO/ZagreusField_3341",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.2, Groups = { "SupportiveShade" }, }
							},
							-- To my greatest fan!
							{
								Cue = "/VO/ZagreusField_3342",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1, Groups = { "SupportiveShade" }, }

							},
							-- There's my Shade!
							{
								Cue = "/VO/ZagreusField_3343",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1, Groups = { "SupportiveShade" }, }
							},
							...
							{
								Cue = "/VO/ZagreusField_3349",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								ConsecutiveClearsOfRoom = { Name = "C_Boss01", Count = 2, },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.5, Groups = { "SupportiveShade" }, }
							},
							-- Was not about to let you down, my Shade!
							{
								Cue = "/VO/ZagreusField_3350",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
							...
							{
								Cue = "/VO/ZagreusField_3351",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								ConsecutiveDeathsInRoom = { Name = "C_Boss01", Count = 1, },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.5, Groups = { "SupportiveShade" }, }
							},
							-- Until next time, good Shade!
							{
								Cue = "/VO/ZagreusField_3352",
								RequiredPlayed = { "/VO/ZagreusField_3026" },
								PreLineThreadedFunctionName = "CrowdReactionPresentationEventSource",
								PreLineThreadedFunctionArgs = { AnimationName = "StatusIconSmile", ReactionChance = 1, Delay = 1.5, Groups = { "SupportiveShade" }, }
							},
				...
				InteractTextLineSets =
				{
					Inspect_C_Shop_01_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}The vast and multitudinous riches of both the surface and the Underworld are hoarded by the river-boatman, Charon, whose services are often tendered to the wealthiest within Elysium."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_C_Reprieve_01_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}Within the delicately hewn constructions of Elysium exist places of peace so utterly serene and absolute as mortalkind is seldom to experience during the average short and often-painful coil."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_C_Story_01_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}Amid Elysium's moss-covered chambers, carved of stone, stand untold numbers of eternal monuments in tribute to the greatest heroes which mortality can offer, there to honor them in life as well as death."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_C_Intro_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}The rare, heavenly splendors of Elysium, reserved for only the most great of mortal souls, spread forth luxuriantly all about the fire-stepping Prince."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_C_Intro_02 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}The enshrouded river of forgetfulness, Lethe, flows through the hallowed chambers of Elysium, numbing old pains and memories of the most-noble shades residing there."
						},
					},
				},
			},
