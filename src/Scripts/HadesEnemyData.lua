	...
	Harpy =
	{
		...
		BossPresentationSuperPriorityIntroTextLineSets =
		{
			FurySistersUnion01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0187",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"We're each well past the need for any sport. We'll kill you, whatever it takes. Erinyes! {#DialogueItalicFormat}Now{#PreviousFormat}."
				},
			},
			FurySistersUnion02 =
			{
				...
				RequiredRoom = "A_Boss01",
				{
					Cue = "/VO/MegaeraField_0419",
					Speaker = "NPC_FurySister_01",
					Text =
					"What's the matter, Zagreus? You look a bit uncomfortable. Something you want to say to me? Or any one of us?"
				},
				{
					Cue = "/VO/ZagreusField_2736",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusInteractionThoughtful",
					PreLineAnimTarget = "Hero",
					Text =
					"Well, it's just... there's something that I wanted to discuss with you, at some point, Meg, but after more consideration, I am thinking maybe now is not the time."
				},
				{
					Cue = "/VO/MegaeraField_0420",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"I understand entirely. Though you should know my sisters and I keep no secrets from each other, anymore. Isn't that right, Sisters?"
				},
			},
			...
			FuryPostSistersUnion01 =
			{
				...
				RequiredRoom = "A_Boss01",
				{
					Cue = "/VO/MegaeraField_0421",
					Speaker = "NPC_FurySister_01",
					Text =
					"{#DialogueItalicFormat}Eugh{#PreviousFormat}, I almost want to thank you, Zagreus. I thought you'd never change that blasted Pact, and leave me here, in peace."
				},
				{
					Cue = "/VO/ZagreusField_2737",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What, you mean you aren't lonelier without Alecto's or Tisiphone's companionship? They seem so wonderful to have around."
				},
				{
					Cue = "/VO/MegaeraField_0422",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"They're tolerable each to some extent. About as much as I can say for you. Now let's the two of us begin."
				},
			},
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			FuryMetSisters01 =
			{
				...
				RequiredInactiveMetaUpgrade = "BossDifficultyShrineUpgrade",
				{
					Cue = "/VO/MegaeraField_0178",
					Speaker = "NPC_FurySister_01",
					Text =
					"I have to level with you, Zagreus. For all we've been through... never once have I wanted you to meet my sisters."
				},
				{
					Cue = "/VO/ZagreusField_1399",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I can't imagine why not! We had a lovely time getting to know each other. We laughed, we cried! My only regret was that you couldn't be there, yourself."
				},
				{
					Cue = "/VO/MegaeraField_0179",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You don't know what you're saying. There's a reason that they're not permitted in the House. Though, come on. One of us is going back there, now."
				},
			},
			...
			FuryMetSisters02 =
			{
				...
				RequiredInactiveMetaUpgrade = "BossDifficultyShrineUpgrade",
				{
					Cue = "/VO/MegaeraField_0180",
					Speaker = "NPC_FurySister_01",
					Text =
					"You've really done it, Zagreus. My sisters have returned. All three of us now share the same assignment."
				},
				{
					Cue = "/VO/ZagreusField_1400",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			FuryNoDarknessReaction01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0414",
					Speaker = "NPC_FurySister_01",
					Text =
					"I sense something different about you, Zagreus. Your old weakness. {#DialogueItalicFormat}Ah{#PreviousFormat}... the Mirror. I thought you said you weren't trying to compete with me?"
				},
				{
					Cue = "/VO/ZagreusField_2735",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I wasn't. But then you gave me a good idea to try. I'm not as weak as I once was. With or without the Mirror's help."
				},
				{
					Cue = "/VO/MegaeraField_0415",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryAboutPersephoneMeeting01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You know... I think I'd rather fight you to the death again than try to answer either of those questions, right now."
				},
				{
					Cue = "/VO/MegaeraField_0708",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryPostEnding01 =
			{
				...
				RequiredFalseSupportAINames = { "Alecto" },
				{
					Cue = "/VO/MegaeraField_0711",
					Speaker = "NPC_FurySister_01",
					Text =
					"Your mother has returned to us, already, Zagreus. And still you're going to keep battling your way out, past me and everything up there? Why?"
				},
				{
					Cue = "/VO/ZagreusField_4305",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Father says there's no escape from here, and I like to repeatedly show him he's wrong. Besides, I think getting out there a bit from time to time does me some good."
				},
				{
					Cue = "/VO/MegaeraField_0712",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Sounds like you've found yourself a steady line of work. Most jobs just need doing. If this one gives you some fulfillment, stick to it. Now, come on."
				},
			},
			...
			FuryAboutEpilogueReunionQuest01 =
			{
				...
				RequiredFalseSupportAINames = { "Alecto" },
				{
					Cue = "/VO/MegaeraField_0748",
					Speaker = "NPC_FurySister_01",
					Text =
					"What is it that you're up to now, Zagreus? The Queen is back. But still you're making me show up like this?"
				},
				{
					Cue = "/VO/ZagreusField_4313",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Got some unfinished business with the Olympians to take care of, was in the area, figured I'd say hi. Hi, Meg!"
				},
				{
					Cue = "/VO/MegaeraField_0749",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryEncounterStoryProgress01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0023",
					Speaker = "NPC_FurySister_01",
					Text =
					"Listen to me, Zagreus. Your mother is long gone. You're never getting out of here, and even if you did, what hope could you possibly have in finding her up in the world out there?"
				},
				{
					Cue = "/VO/ZagreusField_0512",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					Text = "I've hope enough. Not that it's any of your business anymore."
				},
				{
					Cue = "/VO/MegaeraField_0024",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryEncounterGunWeapon01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0164",
					Speaker = "NPC_FurySister_01",
					Text =
					"{#DialogueItalicFormat}What{#PreviousFormat}... where did you get the Rail? Do you know what you have? Where are your customary weapons?"
				},
				{
					Cue = "/VO/ZagreusField_1385",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I left them at home. And, I sort of know what I have, inasmuch as it's largely responsible for getting me this far. Would you like to see a demonstration?"
				},
				{
					Cue = "/VO/MegaeraField_0165",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryEncounterFistWeapon01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0435",
					Speaker = "NPC_FurySister_01",
					Text =
					"What's that you're holding, Zagreus? Please tell me that you didn't steal the most dangerous, unstable artifacts sealed shut within your father's vault."
				},
				{
					Cue = "/VO/ZagreusField_2743",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Erm{#PreviousFormat}, it wasn't I who stole them, if that's any reassurance to you, Meg!"
				},
				{
					Cue = "/VO/MegaeraField_0436",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You are a hopeless fool. You cannot possibly know what you're doing with those things. You put them back exactly where you found them."
				},
			},
			...
			FuryAboutDusaFiring01 =
			{
				...
				RequiredFalseSupportAINames = { "Alecto" },
				{
					Cue = "/VO/MegaeraField_0730",
					Speaker = "NPC_FurySister_01",
					Text = "...Nyx really let Dusa go?"
				},
				{
					Cue = "/VO/ZagreusField_4309",
			...
			FuryPactReaction03 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0446",
					Speaker = "NPC_FurySister_01",
					Text =
					"What have you done with the Pact, Zagreus? This isn't even Asphodel, and I can barely tolerate the heat. Do you really want to die this terribly?"
				},
				{
					Cue = "/VO/ZagreusField_2748",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Appreciate all the concern, but I just thought I'd live a little, Meg. You ought to try it for yourself, sometime!"
				},
				{
					Cue = "/VO/MegaeraField_0447",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
		...
		BossPresentationIntroTextLineSets =
		{
			...
			FuryEncounterStoryProgress02 =
			{
				...
				RequiredFalseSupportAINames = { "Alecto" },
				{
					Cue = "/VO/MegaeraField_0025",
					Speaker = "NPC_FurySister_01",
					Text =
					"Tell me something, Zag, because I'm curious. Do your Olympian relatives know the real reason you've been trying to escape?"
				},
				{
					Cue = "/VO/ZagreusField_0513",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				{
					Cue = "/VO/MegaeraField_0026",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You're in over your head, you idiot. You'll fray what bonds are left between Lord Hades and those ingrates on Olympus."
				},
			},
			...
			FuryAboutBeingClose01 =
			{
				...
				RequiredFalseSupportAINames = { "Alecto" },
				{
					Cue = "/VO/MegaeraField_0437",
					Speaker = "NPC_FurySister_01",
					Text =
					"Things can't entirely be different between you and me. You know that, don't you, Zag? Not when it comes to this, at least."
				},
				{
					Cue = "/VO/ZagreusField_2744",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I do. We wouldn't both be consummate professionals if it were any other way. You won't be going easy on me, will you?"
				},
				{
					Cue = "/VO/MegaeraField_0438",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryAboutBeingClose02 =
			{
				...
				RequiredInactiveMetaUpgrade = "BossDifficultyShrineUpgrade",
				{
					Cue = "/VO/MegaeraField_0441",
					Speaker = "NPC_FurySister_01",
					Text =
					"What is it, Zagreus? You've got that pleased-with-yourself look, which can only mean you have something obnoxious to tell me."
				},
				{
					Cue = "/VO/ZagreusField_2950",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}I never{#PreviousFormat}! Look, I'm simply pleased to see you, Meg. Hence the insuppressible smile. Could have been one of your lovely sisters here instead..."
				},
				{
					Cue = "/VO/MegaeraField_0442",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryAboutPersephoneMeeting02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I think I'm going all the way to the top again, Meg. To find my mother. You won't stop me. Get out of my way."
				},
				{
					Cue = "/VO/MegaeraField_0747",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryAboutPersephoneMeeting03 =
			{
				...
				RequiredFalseSupportAINames = { "Alecto" },
				{
					Cue = "/VO/MegaeraField_0709",
					Speaker = "NPC_FurySister_01",
					Text =
					"Your mother, Zagreus. You really think you'll find her once again, out there? Even if you make it out... maybe she's found another hiding place."
				},
				{
					Cue = "/VO/ZagreusField_2860",
					Portrait = "Portrait_Zag_Serious_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"It isn't us she's hiding from up there. Father let her go. He never wanted to go after her. So I appreciate your concern, but I'll find her again."
				},
				{
					Cue = "/VO/MegaeraField_0710",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"That sounds like information neither one of them would want for me to know. You know the punishment for spilling secrets, don't you?"
				},
			},
			...
			FuryRunClearedReaction02 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0170",
					Speaker = "NPC_FurySister_01",
					Text =
					"What are you doing, Zagreus? The Underworld is sealed off. What you're attempting is impossible. You've seen what happens when you go too far."
				},
				{
					Cue = "/VO/ZagreusField_1388",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"This place can't stay sealed shut forever, Meg. In the meantime, I thought I'd get some practice in, you know?"
				},
				{
					Cue = "/VO/MegaeraField_0171",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryStoryProgress01 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/MegaeraField_0174",
					Speaker = "NPC_FurySister_01",
					Text = "May I help you with something, Zagreus?"
				},
				{
					Cue = "/VO/ZagreusField_1390",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Now that you mention it, you can, Meg. I was wondering what was Father carrying on with you about back home?"
				},
				{
					Cue = "/VO/MegaeraField_0175",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Eavesdropping again? If you must know, my job performance is under review. Though, I'm sure this job's about to go just fine."
				},
			},
			-- Fury Sisters Foreshadow
			FuryStoryProgress02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Now that's a rather ominous thing to say to someone, Meg. Care to explain in terms an idiot like me could understand?"
				},
				{
					Cue = "/VO/MegaeraField_0177",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Lord Hades is exploring other options. He has no confidence in my ability to stop you anymore. Though, maybe it isn't too late for me to change his mind."
				},
			},
			...
			FuryRunProgress01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0166",
					Speaker = "NPC_FurySister_01",
					Text =
					"It's been a while, Zagreus. You must have made it pretty far last time. Let's see. Outer reaches of Asphodel?"
				},
				{
					Cue = "/VO/ZagreusField_1386",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Outer reaches of Asphodel. And I have to say, Meg, you are positively a sight compared with that blasted Bone Hydra stewing away up there."
				},
				{
					Cue = "/VO/MegaeraField_0167",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"How very flattering, to have compared me to the remains of some mindless outsized lizard. Come, maybe I'll kill you just as easily as your new Hydra friend."
				},
			},
			FuryRunProgress02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"We're both immortals, Meg. We'll be seeing plenty of each other for a while yet. I've come to welcome these occasions."
				},
				{
					Cue = "/VO/MegaeraField_0381",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryRunProgress03 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"That Hydra was a total bastard, though. Bastard{#DialogueItalicFormat}s{#PreviousFormat}. But, you sound practically impressed with me, there, Meg! I feel so flattered!"
				},
				{
					Cue = "/VO/MegaeraField_0169",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryRunProgress04 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0439",
					Speaker = "NPC_FurySister_01",
					Text =
					"How utterly disgusting... I was just counting, Zagreus, and as it happens, I have lost to you fifty times, already! If not more. Can you believe this? {#DialogueItalicFormat}Ugh{#PreviousFormat}, how I've fallen."
				},
				{
					Cue = "/VO/ZagreusField_2745",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, don't take it so hard, Meg! Once you die several dozen times, you start to get accustomed to the emotional pain, as well as the physical! Up for some more of either?"
				},
				{
					Cue = "/VO/MegaeraField_0440",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryRunProgress05 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Erm{#PreviousFormat}... feels like a lot, admittedly, I mean, we've been going at this for a while, now. Four hundred and twelve times...?"
				},
				{
					Cue = "/VO/MegaeraField_0755",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"...Five hundred times, exactly. Though I figure, you haven't been keeping track of how many times I've killed you. {#DialogueItalicFormat}Ugh{#PreviousFormat}, maybe that's my problem. Well, plenty of time to work it out after this."
				},
			},
			...
			FuryAboutAlecto01 =
			{
				...
				RequiredInactiveMetaUpgrade = "BossDifficultyShrineUpgrade",
				{
					Cue = "/VO/MegaeraField_0182",
					Speaker = "NPC_FurySister_01",
					Text =
					"You beat Alecto, Zag. Could hear her screaming her head off about it all the way through Tartarus... I almost want to thank you."
				},
				{
					Cue = "/VO/ZagreusField_1401",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
			...
			FuryAboutTisiphone01 =
			{
				...
				RequiredInactiveMetaUpgrade = "BossDifficultyShrineUpgrade",
				{
					Cue = "/VO/MegaeraField_0184",
					Speaker = "NPC_FurySister_01",
					Text =
					"{#DialogueItalicFormat}Huh{#PreviousFormat}. Not even Tisiphone could stop you. Your father must be sorely disappointed."
				},
				{
					Cue = "/VO/ZagreusField_1402",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"He's difficult to please, that much is true. What happened to Tisiphone, anyway? She isn't much for conversation."
				},
				{
					Cue = "/VO/MegaeraField_0185",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryAboutSisyphus01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0425",
					Speaker = "NPC_FurySister_01",
					Text =
					"If there's anyone in all the Underworld who owes you, Zagreus, it's your friend, Sisyphus. He would be much worse off if not for you."
				},
				{
					Cue = "/VO/ZagreusField_2738",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What, because I've been distracting you from administering lashings like before? I hate to think you prefer to whip with no fear of reprisal whatsoever, Meg."
				},
				{
					Cue = "/VO/MegaeraField_0426",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Dereliction of duty and fear of reprisal are not one and the same. Though you don't seem to be concerned with either one."
				},
			},
			...
			FuryNoHammerReaction01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0429",
					Speaker = "NPC_FurySister_01",
					Text =
					"Your weapon's looking rather dull, there, Zagreus. Great Daedalus decided not to grace you with his gifts this time around?"
				},
				{
					Cue = "/VO/ZagreusField_2740",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Now that you mention it, he hasn't, no. Though I'm prepared to say I don't need special augmentations to get past you."
				},
				{
					Cue = "/VO/MegaeraField_0430",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryDarknessReaction01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0379",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"She shouldn't. The only one responsible for all of this is you. And I thought even you would have understood that by now."
				},
			},
			...
			FuryPactReaction01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0172",
					Speaker = "NPC_FurySister_01",
					Text =
					"{#DialogueItalicFormat}Tsch{#PreviousFormat}. I can't believe it. You signed the Pact of Punishment. Have you completely lost your mind? Or just trying to insult me?"
				},
				{
					Cue = "/VO/ZagreusField_1389",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Well if you're going to be so rude about it, maybe a little of each? Though, what do you even care which pacts I sign or don't?"
				},
				{
					Cue = "/VO/MegaeraField_0173",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryPactReaction01_B =
			{
				...
				{
					Cue = "/VO/MegaeraField_0722",
					Speaker = "NPC_FurySister_01",
					Text =
					"{#DialogueItalicFormat}Tsch{#PreviousFormat}. You really volunteered into a Pact of Punishment? You can't back out of it, now. You're even more of a fool than I already thought."
				},
				{
					Cue = "/VO/ZagreusField_4306",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Maybe I just like a challenge, ever thought of that? Besides, what do you even care which pacts I sign or don't?"
				},
				{
					Cue = "/VO/MegaeraField_0723",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You're right. I {#DialogueItalicFormat}don't {#PreviousFormat}care. You want to be punished? Then, come on."
				},
			},
			FuryPactReaction02 =
			{
			...
			FuryPactReaction02_B =
			{
				...
				{
					Cue = "/VO/MegaeraField_0724",
					Speaker = "NPC_FurySister_01",
					Text =
					"You know I can hit even harder than usual with the Pact of Punishment working against you. Maybe that's why you signed it? To pity me?"
				},
				{
					Cue = "/VO/ZagreusField_1397",
					Portrait = "Portrait_Zag_Defiant_01",
			...
			FuryPactReaction04 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0756",
					Speaker = "NPC_FurySister_01",
					Text =
					"This should be over pretty quickly, I think, Zag. Never took you for the Forced Overtime type. That's not a Pact condition for the faint of heart."
				},
				{
					Cue = "/VO/ZagreusField_4317",
					Portrait = "Portrait_Zag_Empathetic_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You wound me, Meg! You know I like to barge into situations thoughtlessly and recklessly, and sort everything out later. Forced Overtime's the perfect fit!"
				},
				{
					Cue = "/VO/MegaeraField_0757",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ahh{#PreviousFormat}, well, when you put it that way. Look, don't go saying I didn't warn you."
				},
			},
			...
			FuryChaosReaction01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0382",
					Speaker = "NPC_FurySister_01",
					Text =
					"Hold it, Zagreus. I sense something, is that... {#DialogueItalicFormat}ah{#PreviousFormat}. You've been in contact with Chaos. So even they are now involved with this."
				},
				{
					Cue = "/VO/ZagreusField_1393",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Just because Chaos is giving me the power to crush you doesn't mean they're getting involved with this, does it?"
				},
				{
					Cue = "/VO/MegaeraField_0383",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryThanatosReaction02 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0395",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"How dare you...! If you like death so much, then here, let me indulge you. Thanatos will welcome you with open arms."
				},
			},
			...
			FuryHighRelationship01 =
			{
				...
				RequiredAnyTextLines = { "BecameCloseWithMegaera01", "BecameCloseWithMegaera01_B" },
				{
					Cue = "/VO/MegaeraField_0726",
					Speaker = "NPC_FurySister_01",
					Text =
					"Prince Zagreus, you are trespassing beyond the limits of your authority. I am under orders to stop you."
				},
				{
					Cue = "/VO/ZagreusField_4307",
					Portrait = "Portrait_Zag_Empathetic_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Come on, Meg, why so formal all of a sudden? We've been through this countless times. Wait, is it because...?"
				},
				{
					Cue = "/VO/MegaeraField_0727",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryHighRelationship02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Well, it's just... can we really keep the personal and the professional completely separate like this, Meg? It's with mixed emotions that I fight you to the death, only to be happy to see you back at the House."
				},
				{
					Cue = "/VO/MegaeraField_0729",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Then learn to keep your emotions in check. You keep them bottled up a while, they'll be that much stronger when it's time to let them out."
				},
			},
			...
			FuryEncounterFistWeapon02 =
			{
				...
				RequiredWeapon = "FistWeapon",
				{
					Cue = "/VO/MegaeraField_0752",
					Speaker = "NPC_FurySister_01",
					Text =
					"Nice gloves, there, Zagreus. Think you can take me up close with those things? Well within striking distance of my whip."
				},
				{
					Cue = "/VO/ZagreusField_4315",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Not wearing them for fashion's sake, here, Meg. You won't mind if I give you my best shot with Malphon here, will you?"
				},
				{
					Cue = "/VO/MegaeraField_0753",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryAboutWeaponEnchantments01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0427",
					Speaker = "NPC_FurySister_01",
					Emote = "PortraitEmoteSurprise",
					Text =
					"What happened to your weapon, Zagreus? I sensed its power long before you turned up. That isn't just some Daedalus enchantment on it."
				},
				{
					Cue = "/VO/ZagreusField_2739",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, Stygius and I have been getting much more closely acquainted lately, Meg. Would you care to see the fruits of our healthy symbiotic relationship?"
				},
				{
					Cue = "/VO/MegaeraField_0428",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryKeepsakeReaction01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Why, because the gift you generously gave me may end up being instrumental in your own demise? Sounds straight out of one of those tales the mortals like to go spreading around."
				},
				{
					Cue = "/VO/MegaeraField_0733",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"They like it when best-laid plans fall completely to pieces, don't they? You better grow to like it, too."
				},
			},
			...
			FuryThanatosKeepsakeReaction01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, this old thing? It's just a listless butterfly Than gave me, which happens to fill me with even more supernatural strength than usual. Don't pay it any mind."
				},
				{
					Cue = "/VO/MegaeraField_0432",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryLegendaryKeepsakeReaction01_B =
			{
				...
				{
					Cue = "/VO/MegaeraField_0734",
					Speaker = "NPC_FurySister_01",
					Text =
					"You know Battie's not going to work here, don't you? I'm definitely not going to help you out of this one."
				},
				{
					Cue = "/VO/ZagreusField_4311",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Come on, Meg, you can do anything if you set your mind to it! Though, don't worry, Battie's just here for the show."
				},
				{
					Cue = "/VO/MegaeraField_0735",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryLegendaryKeepsakeReaction01 =
			{
				...
				RequiredAssistKeepsake = "FuryAssistTrait",
				{
					Cue = "/VO/MegaeraField_0443",
					Speaker = "NPC_FurySister_01",
					Text =
					"Your little bat companion not too much to handle, is she, Zagreus? I trust you're taking excellent care of her. Not that she needs your help."
				},
				{
					Cue = "/VO/ZagreusField_2747",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh she's been positively perfect, thank you, Meg. Especially in how she puts us into contact when I need a hand. I hope it's not too much hassle, helping out from time to time?"
				},
				{
					Cue = "/VO/MegaeraField_0444",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryLowHealth01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0384",
					Speaker = "NPC_FurySister_01",
					Text =
					"Look at yourself, Zagreus, you are a total mess. Halfway to death or worse. You're making this too easy."
				},
				{
					Cue = "/VO/ZagreusField_1394",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
			...
			FuryLowHealth02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I figured I'd give you a head start this time, so I let the wretched shades bludgeon me repeatedly along the way."
				},
				{
					Cue = "/VO/MegaeraField_0387",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Fool. If you're half-dead already by the time you get to me, what hope can you possibly have for what lies ahead?"
				},
			},
			FuryLowHealth03 =
			{
			...
			FuryLowHealth04 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"No, not just yet, though thanks for asking, Meg. If you intend to force me, know that I am going to resist, with all my might."
				},
				{
					Cue = "/VO/MegaeraField_0434",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
		...
		BossPresentationTextLineSets =
		{
			FuryEncounter01 =
			{
				PlayOnce = true,
				{
					Cue = "/VO/MegaeraField_0006",
					Speaker = "NPC_FurySister_01",
					Text =
					"Ever stubborn, aren't you. Maybe my whip might make you reconsider whatever it is that you're attempting here."
				},
				{
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					Cue = "/VO/ZagreusField_0462",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					PostLineAnim = "ZagreusTalkDenialReturnToIdle",
					PostLineAnimTarget = "Hero",
			...
			FuryEncounter02 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0008",
					Speaker = "NPC_FurySister_01",
					Text =
					"And there you are again. Lord Hades ought to lock you up rather than let you run amok in his domain like this."
				},
				{
					Cue = "/VO/ZagreusField_0505",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I'm sure he'd welcome all this feedback from you, Meg. Or maybe you're just pining for my father's job?"
				},
				{
					Cue = "/VO/MegaeraField_0009",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryWinStreak01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0018",
					Speaker = "NPC_FurySister_01",
					Text =
					"{#DialogueItalicFormat}Pff{#PreviousFormat}. And here you are again. You're slow to learn the way of things I see."
				},
				{
					Cue = "/VO/ZagreusField_0510",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					Text = "I may be slow to learn, but... least I'm rather patient!"
				},
				{
					Cue = "/VO/MegaeraField_0019",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			FuryWinStreak03 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0014",
					Speaker = "NPC_FurySister_01",
					Text = "You're never getting past me, Zagreus."
				},
				{
					Cue = "/VO/ZagreusField_0508",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			FuryLoseStreak01 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0021",
					Speaker = "NPC_FurySister_01",
					Text =
					"Even if you manage to get past me, there's no getting out of Asphodel. You saw what it was like. You really want to go back there?"
				},
				{
					Cue = "/VO/ZagreusField_0511",
					Portrait = "Portrait_Zag_Serious_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			FuryLoseStreak02 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0020",
					Speaker = "NPC_FurySister_01",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Finally, you're back. You won't get past me like you did last time. Though, I would like to see you try."
				},
			},
			...
			FuryPreMatchHighAffinity03 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0029",
					Speaker = "NPC_FurySister_01",
					PreLineFunctionName = "StartBossRoomMusic",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					Text =
					"I guess we know the drill by now, don't we. Not that I don't enjoy our little arguments, in my own way."
				},
			},
		},
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			FuryMiscStartLoseStreak14 =
			{
				...
				{
					Cue = "/VO/MegaeraField_0745",
					Speaker = "NPC_FurySister_01",
					PreLineFunctionName = "StartBossRoomMusic",
					PreLineAnim = "FuryTaunt",
					PreLineWait = 0.35,
					Text =
					"{#DialogueItalicFormat}Ungh{#PreviousFormat}, I've practically lost count how many times you beat me in a row here, Zag..."
				},
			},
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			...
			Fury2SisterUnionWithMeg01 =
			{
				...
				RequiredRoom = "A_Boss02",
				{
					...
					Text =
					"{#DialogueItalicFormat}Ugh{#PreviousFormat}, would you just {#DialogueItalicFormat}look {#PreviousFormat}at him! That smug look, that posture, {#DialogueItalicFormat}everything{#PreviousFormat}! Please tell me you're not going soft for this trash-god, Sister."
				},
				{
					Cue = "/VO/MegaeraField_0423",
					Speaker = "NPC_FurySister_01",
					Portrait = "Portrait_FurySister01_Default_01",
					Text =
				...
				},
				{
					...
					PreLineThreadedFunctionArgs = { Emote = "PortraitEmoteAnger", DoShake = true, WaitTime = 3.65 },
					PreLineFunctionName = "StartBossRoomMusic",
					PreLineAnim = "AlectoTaunt",
					PreLineWait = 0.35,
					Text =
					"You know, fair point, there, Sister! Very nicely said. {#DialogueItalicFormat}Let's kill him, now{#PreviousFormat}!"
				},
			},
			...
			Fury2SisterUnionWithMeg02 =
			{
				...
				},
				{
					...
					PreLineWait = 0.35,
					Text =
					"The both of you disgust me, Meg, you know that? Get it together and {#DialogueItalicFormat}kill {#PreviousFormat}him this time, damn you!"
				},
			},
			...
			Fury2PactReaction01 =
			{
				...
				},
				{
					...
					Emote = "PortraitEmoteAnger",
					Text =
					"I like working {#DialogueItalicFormat}alone{#PreviousFormat}! And you don't see me doing that, right now, do you? So I would say it's my business, all right. Along with killing {#DialogueItalicFormat}you{#PreviousFormat}!"
				},
			},
			...
			Fury2PactDisabledReaction01 =
			{
				...
				RequiredRoom = "A_Boss02",
				{
					...
					Text =
					"{#DialogueItalicFormat}Whew{#PreviousFormat}, I thought I'd never get some quiet time again, you know, redblood? That damned Pact you stupidly agreed to, making me work with my sisters again. I'll get you for that!"
				},
				{
					Cue = "/VO/ZagreusField_3809",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I'm sensing a pattern that it really doesn't take much for you to have something to {#DialogueItalicFormat}get {#PreviousFormat}me for, does it?"
				},
				{
					Cue = "/VO/Alecto_0330",
					PreLineAnim = "AlectoTaunt",
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Oh, that's rich! How smart of you, you're {#DialogueItalicFormat}smart{#PreviousFormat}! Know what? I'll get you for that, too."
				},
			},
		...
		BossPresentationIntroTextLineSets =
		{
			...
			Fury2PostEnding02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You call this a good habit, huh? Maybe for me, it is. Well, come here all you like, and I will be here waiting, {#DialogueItalicFormat}every single time{#PreviousFormat}! About once every three times, anyway."
				},
			},
			Fury2PostEpilogue01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Hohoho{#PreviousFormat}, I'm sure you did. But, you know, work comes first! So let's get busy."
				},
			},
			...
			Fury2EndOfDiscussion01 =
			{
				...
				RequiredFalseSupportAINames = { "Megaera" },
				{
					Cue = "/VO/Alecto_0321",
					Text =
					"Hey, redblood. I have done a lot of thinking, and I've come to the conclusion that I want you {#DialogueItalicFormat}never {#PreviousFormat}to speak to me again. {#DialogueItalicFormat}Ever{#PreviousFormat}. Got that?"
				},
				{
					Cue = "/VO/ZagreusField_3807",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PreLineWait = 0.35,
					Text =
					"...{#DialogueItalicFormat}Erm{#PreviousFormat}, I don't know how to respond to what you said without directly disobeying your request, Alecto. But for future reference, fine, I'll bite."
				},
				{
					Cue = "/VO/Alecto_0322",
					PreLineAnim = "AlectoTaunt",
					...
					Emote = "PortraitEmoteFiredUp",
					Text =
					"You'll {#DialogueItalicFormat}die{#PreviousFormat}! There's no use standing here flapping our gums when we could cut to killing one another right away. Come on!"
				},
			},
			...
			Fury2LowHealth01 =
			{
				...
				RequiredMaxLastStands = 1,
				{
					Cue = "/VO/Alecto_0313",
					Text =
					"{#DialogueItalicFormat}Ahh{#PreviousFormat}, look at you, redblood. You're practically already dead! Now that's no fun at all."
				},
				{
					Cue = "/VO/ZagreusField_1421",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			Fury2LowHealth03 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Oh {#DialogueItalicFormat}whew{#PreviousFormat}, that's a relief all right! I was so worried that I wasn't going to be the one to kill you this time."
				},
			},
			Fury2LowHealth04 =
			{
		...
		BossPresentationTextLineSets =
		{
			...
			Fury2MiscEncounter04 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ehh{#PreviousFormat}, we'll find out. I've got plenty of ideas left I've been meaning to try."
				},
			},
			...
			Fury2MiscEncounter06 =
			{
				...
				RequiredTextLines = { "Fury2MiscEncounter02" },
				{
					Cue = "/VO/Alecto_0019",
					Text =
					"{#DialogueItalicFormat}Huh{#PreviousFormat}! You really must like pain an awful lot, redblood. Or maybe it's just me."
				},
				{
					Cue = "/VO/ZagreusField_1417",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					Emote = "PortraitEmoteSurprise",
					Text =
					"Did you just--? Don't you {#DialogueItalicFormat}ever {#PreviousFormat}compare yourself to me again, you trash. You want more pain, I'm happy to oblige."
				},
			},
			...
			Fury2MiscEncounter09 =
			{
				...
				RequiredFalseSupportAINames = { "Megaera" },
				{
					Cue = "/VO/Alecto_0375",
					Text =
					"You know, redblood, my appointments usually don't come to {#DialogueItalicFormat}me{#PreviousFormat}, much less again and again! Think I'm here to show you a good time, huh?!"
				},
				{
					Cue = "/VO/ZagreusField_3811",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					Emote = "PortraitEmoteSurprise",
					Text =
					"{#DialogueItalicFormat}Whaa{#PreviousFormat}?! You think dealing with {#DialogueItalicFormat}me {#PreviousFormat}beats dealing with that {#DialogueItalicFormat}weakling{#PreviousFormat}? {#DialogueItalicFormat}Graaaah{#PreviousFormat}!"
				},
			},
			Fury2MiscEncounter10 =
			{
				...
				RequiredMinTimesSeenRoom = { A_Boss02 = 20 },
				{
					Cue = "/VO/Alecto_0377",
					PreLineThreadedFunctionName = "PlayEmoteAnimFromSource",
					PreLineThreadedFunctionArgs = { Emote = "PortraitEmoteAnger", DoShake = true, WaitTime = 3.0 },
					Text =
					"How many times is it going to take, redblood? {#DialogueItalicFormat}How many{#PreviousFormat}?! Tell me! How can you stand running into me like this, over and over?"
				},
				{
					Cue = "/VO/ZagreusField_3812",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			Fury2AboutMegaeraRelationship01 =
			{
				...
				RequiredFalseSupportAINames = { "Megaera" },
				{
					Cue = "/VO/Alecto_0381",
					Text =
					"{#DialogueItalicFormat}Eugh{#PreviousFormat}, still can't believe Megaera got mixed up with you, redblood. For all her weakness, I always thought at least she took her job here seriously. {#DialogueItalicFormat}Eh{#PreviousFormat}, live and learn!"
				},
				{
					Cue = "/VO/ZagreusField_3814",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					Emote = "PortraitEmoteAffection",
					Text =
					"{#DialogueItalicFormat}Ohh{#PreviousFormat}, you might get {#DialogueItalicFormat}mad{#PreviousFormat}? Defend Megaera's honor, since she's far too weak to do it her damn self? You think she's so pure! {#DialogueItalicFormat}Hahaha{#PreviousFormat}! You're disgusting! Both of you."
				},
			},
			...
			Fury2WinStreak02 =
			{
				...
				},
				{
					Cue = "/VO/Alecto_0017",
					Text =
					"{#DialogueItalicFormat}Huh{#PreviousFormat}! Normally my marks don't make a habit of seeking me out again after I'm through with them."
				},
				{
					Cue = "/VO/ZagreusField_1416",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ugh{#PreviousFormat}, I do so hate to let you down like this, redblood. But you're just not my type. Maybe I'll finally get it through your head this time."
				},
			},
			...
			Fury2LoseStreak01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					PreLineThreadedFunctionName = "PlayEmoteAnimFromSource",
					PreLineThreadedFunctionArgs = { Emote = "PortraitEmoteFiredUp", DoShake = true, WaitTime = 3 },
					Text =
					"You think we're making progress? Here? {#DialogueItalicFormat}Ah, hah, ha-hah, ha-hah, ha-hah, {#PreviousFormat}why you piece of trash! I'll show you progress."
				},
			},
			Fury2LoseStreak02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You see? That is {#DialogueItalicFormat}exactly {#PreviousFormat}what I mean. To think that Megaera had to put up with you for, I don't know how long."
				},
			},
			Fury2LoseStreak03 =
			{
				...
				},
				{
					Cue = "/VO/Alecto_0025",
					Text =
					"Damn you for this, redblood. You're making me look bad, you know? Making me {#DialogueItalicFormat}feel {#PreviousFormat}bad."
				},
				{
					Cue = "/VO/ZagreusField_1420",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ah-hahah-hahaha, hahah{#PreviousFormat}, you do know what happens when you make me {#DialogueItalicFormat}feel {#PreviousFormat}bad, don't you...? "
				},
			},
			Fury2LoseStreak04 =
			{
				...
				},
				{
					Cue = "/VO/Alecto_0319",
					Text =
					"{#DialogueItalicFormat}Huh{#PreviousFormat}, it's the god of trash, come once again to filthy up this place! You're getting real predictable, you know."
				},
				{
					Cue = "/VO/ZagreusField_3806",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			Fury2SistersUnionRepeatable09 =
			{
				...
				RequiredRoom = "A_Boss02",
				{
					...
					Emote = "PortraitEmoteCheerful",
					Text =
					"Oh, {#DialogueItalicFormat}hohohohoho{#PreviousFormat}, look at him, sisters! Don't you just want to whip him all to shreds?!"
				},
			},
			...
			Fury2MiscStart22 =
			{
				RequiredTextLines = { "Fury2MiscEncounter02" },
				{
					...
					PreLineWait = 0.35,
					Text =
					"What's the matter, there, redblood? Gone awful quiet! Did I hurt your feelings, {#DialogueItalicFormat}huh{#PreviousFormat}?"
				},
			},
			Fury2MiscStart23 =
			{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"You want to mess with me {#DialogueItalicFormat}again{#PreviousFormat}, redblood?! Well then, {#DialogueItalicFormat}come on{#PreviousFormat}!"
				},
			},
			Fury2MiscStart25 =
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"How is it possible I am so sick of you, but never sick of {#DialogueItalicFormat}killing {#PreviousFormat}you, redblood?"
				},
			},
			Fury2MiscStart26 =
			{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"I'm real sick of waiting here, so how about we make this {#DialogueItalicFormat}real quick{#PreviousFormat}, redblood!"
				},
			},
			Fury2MiscStart31 =
			{
		...
		BossPresentationIntroTextLineSets =
		{
			...
			Fury3PostEnding01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I'm here on official business this time, Tisiphone, so, {#DialogueItalicFormat}uh{#PreviousFormat}... stand aside! Although, I guess the whole point of this job is that you're meant to try and stop me anyway, isn't that right?"
				},
				{
			...
			Fury3PostEpilogue01 =
			{
				...
				RequiredTextLines = { "OlympianReunionQuestComplete" },
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, sorry that you couldn't make the feast back at the House, Tisiphone. Though, I don't really think it was your kind of scene. Although, Ares was there, he's probably done some murders, right?"
				},
				{
		...
		BossPresentationTextLineSets =
		{
			...
			Fury3Encounter05 =
			{
				...
				},
				{
					...
					PreLineThreadedFunctionName = "PlayEmoteAnimFromSource",
					PreLineThreadedFunctionArgs = { Emote = "PortraitEmoteAnger", WaitTime = 1.7 },
					PreLineAnim = "TisiphoneTaunt_2",
					PreLineWait = 0.35,
					PreLineFunctionName = "StartBossRoomMusic",
			...
			Fury3Encounter07 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"No, murder. Zagreus. My name is Zagreus! Can you say that, Tisiphone? No murder. {#DialogueItalicFormat}Zagreus{#PreviousFormat}!"
				},
				{
			...
			Fury3Encounter08 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You really did say {#DialogueItalicFormat}murderzer{#PreviousFormat}, didn't you! That's progress! Zagreus! I'm Zagreus, I'm not a murderer! Can you say Zagreus?"
				},
				{
			...
			Fury3Encounter09 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Do you remember me, Tisiphone? My name is Zagreus. Prince of the Underworld? Pretty close with Megaera, I guess. Try saying Zagreus again for me?"
				},
				{
			...
			Fury3Encounter10 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, you're so close, Tisiphone! Remember, Zagreus? That's me. I'm not your enemy, you know, don't you know that? I'm only Zagreus!"
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					PreLineThreadedFunctionName = "PlayEmoteAnimFromSource",
					PreLineThreadedFunctionArgs = { Emote = "PortraitEmoteSurprise", DoShake = true, WaitTime = 5.6 },
			...
			Fury3Encounter11 =
			{
				...
				{
					Cue = "/VO/ZagreusField_3831",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					Emote = "PortraitEmoteSurprise",
					Text =
					"No. Wait. Just the first part. No murderer. Just Zagreus. Or... let's see, how about... {#DialogueItalicFormat}happy{#PreviousFormat}? Can you say {#DialogueItalicFormat}happy{#PreviousFormat}?"
				},
				{
			...
			Fury3Encounter12 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Erm{#PreviousFormat}, well... let's try again with {#DialogueItalicFormat}happy{#PreviousFormat}, how about that? Happy? No murder, only happy. Come on, now!"
				},
				{
			...
			Fury3Encounter13 =
			{
				...
				{
					Cue = "/VO/ZagreusField_3835",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusInteractionThoughtful",
					PreLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Eugh{#PreviousFormat}, I guess the {#DialogueItalicFormat}happy {#PreviousFormat}thing just isn't doing it for you. Though, maybe trying to kill me like this is as close as you can get. You learned my name at least, that's something, right?"
				},
				{
			...
			Fury3Encounter14 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"...Then we're back to square one. Look, I was just trying to get through to you with all the Zagreus and happy stuff. But, if you can understand any of this, Tisiphone, I think you're all right, just the way you are. Friends?"
				},
				{
			...
			Fury3Encounter15 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Hey, {#DialogueItalicFormat}uhh{#PreviousFormat}, any second thoughts, by any chance, about the whole {#DialogueItalicFormat}happy {#PreviousFormat}thing? Just making sure."
				},
				{
		...
		BossPresentationSuperPriorityIntroTextLineSets =
		{
			TheseusExtremeMeasures01 =
			{
				...
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 3 },
				{
					...
					Text =
					"{#DialogueItalicFormat}Ah, hahaha{#PreviousFormat}, it's finally time, Asterius. He's here! Aren't you, now, you vile, insignificant hellspawn? Prepare now to be overrun!!"
				},
				{
					Cue = "/VO/ZagreusField_2750",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Pah{#PreviousFormat}! You don't deserve to know. Suffice it that Asterius and I were handsomely rewarded once again. And we shall not hesitate to exploit our hard-fought spoils against {#DialogueItalicFormat}you{#PreviousFormat}!"
				},
			},
			TheseusAboutFraternalBonds02 =
			{
				...
				RequiredTextLines = { "TheseusAboutFraternalBonds01" },
				{
					...
					Emote = "PortraitEmoteDepressed",
					Text =
					"He would pit you against me, Asterius. I can see it in his mis-matched eyes! I cannot shake the terrible vision that, someday or night, it shall be me, standing alone here, whilst you...? Whilst you take sides against me! With that {#DialogueItalicFormat}fiend{#PreviousFormat}!"
				},
				{
					Cue = "/VO/ZagreusField_3880",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusInteractionThoughtful",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}You poisonous worm{#PreviousFormat}! I knew you had a more sinister trick at play, because your fighting style certainly is of no concern just on its own! Are there truly no depths to which you would not stoop?!"
				},
			},
			TheseusAboutFraternalBonds03_A =
			{
				...
				RequiredMaxActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 2 },
				{
					...
					Emote = "PortraitEmoteFiredUp",
					Text =
					"...I'm telling you, you're {#DialogueItalicFormat}wrong{#PreviousFormat}, Asterius! He is no {#DialogueItalicFormat}royalty{#PreviousFormat}, most certainly not any {#DialogueItalicFormat}I {#PreviousFormat}would recognize! He's but a nameless, long-forgotten minor god born of the depths, and bound to stay in them!"
				},
				{
					Cue = "/VO/Minotaur_0283",
					Speaker = "Minotaur",
				...
				},
				{
					...
					Emote = "PortraitEmoteSurprise",
					Text =
					"{#DialogueItalicFormat}Bravely{#PreviousFormat}?! Hiding behind those pillars is what you call {#DialogueItalicFormat}bravely{#PreviousFormat}, Asterius? We shall have to discuss this strange lapse of judgment after we achieve our victory!"
				},
			},
			...
			TheseusAboutFraternalBonds04_A =
			{
				...
				RequiredMaxActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 2 },
				{
					...
					Emote = "PortraitEmoteDepressed",
					Text =
					"I hope you're perfectly pleased with yourself, hellspawn. Because Asterius has been quite cross with me! Such as he is. He says I have misjudged the likes of you! {#DialogueItalicFormat}Outrageousness{#PreviousFormat}."
				},
				{
					Cue = "/VO/Minotaur_0284",
					Speaker = "Minotaur",
					Portrait = "Portrait_Minotaur_Default_01",
					Text =
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"And now, you're saying I can't fight, Asterius? Even though I had no difficulty besting {#DialogueItalicFormat}you {#PreviousFormat}within that maze of yours?! Come on, let's do this fight!"
				},
			},
			...
			TheseusAboutFraternalBonds06_A =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"I... oh, my dear friend, Asterius. I see, of course, you're right, you're right. {#DialogueItalicFormat}You're right{#PreviousFormat}! And I solemnly do swear to you, indeed, that I shall never again doubt our brotherhood! Nor shall I ever listen to this fiend! Together, now and always!!"
				},
			},
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			TheseusExtremeMeasures02 =
			{
				...
				},
				{
					...
					Emote = "PortraitEmoteFiredUp",
					Text =
					"{#DialogueItalicFormat}Hahahahah{#PreviousFormat}, what?! You claim to be my benefactor, when in truth, you are my figuratively mortal enemy?! I'll do the chariot-equivalent of trample you!"
				},
			},
			TheseusExtremeMeasures03 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Theseus, you do know you look even more ridiculous than normal wearing that mask? I get the chariot and the unsporting weaponry, but why wear {#DialogueItalicFormat}that {#PreviousFormat}thing?"
				},
				{
					Cue = "/VO/Theseus_0553",
					PreLineWait = 0.35,
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Bah! {#PreviousFormat}This blessed mask was crafted by great Daedalus, himself! A work of art, and my entitled claim as champion! What has he ever done for you?!"
				},
			},
			...
			TheseusPactReverted01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Nonsense, my friend! For how can one underestimate that which deserves no esteem whatsoever?! Together, now, {#DialogueItalicFormat}attack{#PreviousFormat}!"
				},
			},
			TheseusExtremeMeasures_IfYouWon01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"The only thing which shall be totaled here, you heartless property-destroying scourge, is {#DialogueItalicFormat}you yourself{#PreviousFormat}! Asterius!! Together, let us break him!"
				},
			},
			TheseusExtremeMeasures_IfYouWon02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Silence{#PreviousFormat}!! Show me a finer chariot-driver anywhere within Elysium, why, you cannot! I'll run you down for such an insult to my pride!"
				},
			},
			TheseusExtremeMeasures_IfYouWon03 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"And {#DialogueItalicFormat}I{#PreviousFormat}, fiend, am impressed that {#DialogueItalicFormat}you {#PreviousFormat}yet live and breathe! A temporary state Asterius and I shall soon alleviate! {#DialogueItalicFormat}To war{#PreviousFormat}!!"
				},
			},
			...
			TheseusPoseidonQuestReaction01 =
			{
				...
				},
				{
					...
					Emote = "PortraitEmoteAnger",
					Text =
					"How {#DialogueItalicFormat}dare {#PreviousFormat}you to invoke my Lord Poseidon's name?! And, to besmirch our complicated past! No god shall ever favor you as he has favored both Asterius and me!"
				},
			},
		},
		...
		BossPresentationIntroTextLineSets =
		{
			...
			TheseusSecondEncounter01_IfYouLost =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Silence{#PreviousFormat}, you monster! I'll hear no more such wicked lies, half-truths, or quarter-truths! You, however, soon shall hear my blessed spear! Specifically, the sound it makes whilst sliding into your exposed midsection! Defend yourself!"
				},
			},
			TheseusSecondEncounter01_IfYouWon =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Besmirch {#DialogueItalicFormat}what {#PreviousFormat}honor? You're just complaining that you lost. Even though I was outnumbered!"
				},
				{
					Cue = "/VO/Theseus_0006",
					Emote = "PortraitEmoteFiredUp",
			...
			TheseusAboutGilgameshAspect01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"What are you telling me, Asterius? Now is certainly not a good time for waxing philosophical, I think! And, surely this King Gilgamesh of whom you speak is much more competent a fighter than {#DialogueItalicFormat}this {#PreviousFormat}filth!"
				},
			},
		...
		BossPresentationTextLineSets =
		{
			TheseusEncounter01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"That {#DialogueItalicFormat}Minotaur {#PreviousFormat}whom you address is my dear friend, you preconceiving stain upon the earth! Asterius and I are brothers here in death as we were enemies in life. Not that you could ever understand fraternal bonds as strong as ours!"
				},
			},
			TheseusEncounter02 =
			{
				...
				RequiredTextLines = { "TheseusEncounter01" },
				{
					...
					Emote = "PortraitEmoteSparkly",
					Text =
					"{#DialogueItalicFormat}Ah-hah{#PreviousFormat}, the fiend comes crawling back once more, drawn as he is much like the unassuming moth unto the flame of righteousness!"
				},
				{
					Cue = "/VO/ZagreusField_1768",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
			...
			TheseusEncounter04 =
			{
				...
				RequiredTextLines = { "TheseusEncounter03" },
				{
					...
					Emote = "PortraitEmoteSparkly",
					Text =
					"{#DialogueItalicFormat}Ah, hahaha, {#PreviousFormat}you are just in time, Fiend from Lowest Depths! Asterius and I have trained extensively since our last skirmish here!"
				},
				{
					Cue = "/VO/ZagreusField_1770",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"And who are {#DialogueItalicFormat}you {#PreviousFormat}to judge, you misbegotten, shameful, unfilial maggot? It is an {#DialogueItalicFormat}honor {#PreviousFormat}to have the opportunity to spend my afterlife perpetually standing in your ruinous path!"
				},
			},
			TheseusEncounter05 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}God-hated{#PreviousFormat}? You'll have to be more specific. I have the gods on my side. Though I suppose you do, too. Why can't they make up their minds?"
				},
				{
					Cue = "/VO/Theseus_0016",
					Emote = "PortraitEmoteFiredUp",
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"They {#DialogueItalicFormat}have {#PreviousFormat}made up their minds! They stand united against darkness, as do I! With the exception of Asterius, here, who serves the light! Let's serve it now, my friend! To battle!"
				},
			},
			...
			TheseusWinStreak01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Your lesson, monster, is to never, {#DialogueItalicFormat}ever {#PreviousFormat}take up arms against those favored by the gods themselves! You shall never see the light of day as I once did! Uh, no offense, Asterius."
				},
			},
			-- theseus lose streak
			TheseusLoseStreak01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Shouldn't {#DialogueItalicFormat}I {#PreviousFormat} be the Champion of Elysium, now that I've beaten you? Isn't there someone else around to challenge me, say, Heracles? Someone less chatty?"
				},
				{
					Cue = "/VO/Theseus_0020",
					Emote = "PortraitEmoteSparkly",
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ah, hahaha, {#PreviousFormat}very clever, fiend. Invoking Heracles' name, in an attempt to drive me to a jealous rage. It shall not work! But you shall dearly pay nevertheless!"
				},
			},
			...
			TheseusLoseStreak02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"You take that back about Elysium! Or, better: I shall make you eat those careless, inappropriate remarks! Come, Asterius, {#DialogueItalicFormat}to war{#PreviousFormat}!"
				},
			},
			...
			TheseusWithAsterius03 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Oh, I am perfectly alert right now, Asterius! And were I still alive, I would be positively salivating at the thought of running through this pustule with my spear, or whichever means I had available! Now, {#DialogueItalicFormat}let's go{#PreviousFormat}!"
				},
			},
			...
			TheseusPostEnding01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Oh, {#DialogueItalicFormat}hoho{#PreviousFormat}, such {#DialogueItalicFormat}clever {#PreviousFormat}excuse-making from one so versed in treachery! Well, if you are indeed contained within this realm, then we shall be delighted to make sure it always stays that way! Now come and fight!"
				},
			},
			TheseusPostEpilogue01 =
			{
				...
				},
				{
					...
					Emote = "PortraitEmoteAnger",
					Text =
					"Oh, you disgust me, daemon, that you would even dare to say such things about the Queen! Prepare now to be {#DialogueItalicFormat}vanquished {#PreviousFormat}in her name!"
				},
			},
			...
			TheseusLowHealth02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Effort, {#DialogueItalicFormat}pah{#PreviousFormat}! You shall be imminently slain, and {#DialogueItalicFormat}effortlessly{#PreviousFormat}, I am quite certain of that! Asterius, to arms!!"
				},
			},
			TheseusLowHealth03 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Hah! {#PreviousFormat}What would you know of trust! Being a vile, grievously-wounded-already creature such as you are! Asterius, let's end his misery!"
				},
			},
			...
			TheseusYarnReaction02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Nothing shall be bottled {#DialogueItalicFormat}here{#PreviousFormat}, you filth! That she became enamored of me was not my responsibility, besides! She was naive! The same as you."
				},
			},
			TheseusYarnReaction03 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Maybe {#DialogueItalicFormat}you {#PreviousFormat}should {#DialogueItalicFormat}shut up{#PreviousFormat}!! That Ariadne's dead to me. She has been since we were alive! I cherish her memory, yes. But only because, if not for her, I'd not have met Asterius! Now, meet his axe!!"
				},
			},
			-- alt below
			TheseusYarnReaction04 =
			{
				...
				{
					Cue = "/VO/Minotaur_0265",
					Speaker = "Minotaur",
					Portrait = "Portrait_Minotaur_Default_01",
					Text =
					"King. The princess Ariadne was my sister, if you don't recall. Please do not denigrate her memory. {#DialogueItalicFormat}<Snort> {#PreviousFormat}You're making me upset."
				},
				{
					Cue = "/VO/Theseus_0288",
					Emote = "PortraitEmoteSurprise",
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ah{#PreviousFormat}, no, my friend! I meant you no offense! But I'd no love for her, was that my fault?! {#DialogueItalicFormat}Pff{#PreviousFormat}, forgive me. I... I shall seek her out. Someday or night. But first!! This daemon {#DialogueItalicFormat}has {#PreviousFormat}to be destroyed. Together, no?!"
				},
			},
			...
			TheseusAutographReaction01 =
			{
				...
				RequiredTextLines = { "HypnosAutograph01" },
				{
					...
					Emote = "PortraitEmoteSparkly",
					Text =
					"Now hold a moment, fiend! Asterius made me aware that you recently asked of him an {#DialogueItalicFormat}autograph{#PreviousFormat}. A tribute to his fame! As I am Champion, I am prepared to generously offer mine, as well."
				},
				{
					Cue = "/VO/ZagreusField_2760",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					Emote = "PortraitEmoteAnger",
					Text =
					"{#DialogueItalicFormat}Ah, pffsch{#PreviousFormat}, you...! 'Twas merely a jest! I'd not have given you the cloth about my loins, much less my name! But a fight you certainly shall have!"
				},
			},
			...
			TheseusAboutGods01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You {#DialogueItalicFormat}do {#PreviousFormat}know I'm related to them, right? The god of the dead is my father? I'm sure word's gotten around. Not that I want deferential treatment from the likes of you."
				},
				{
					Cue = "/VO/Theseus_0537",
					Emote = "PortraitEmoteFiredUp",
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Good! For you'll get nothing of the sort. The gods are on {#DialogueItalicFormat}my {#PreviousFormat}side, not yours, monster! What business would they have, abetting you?"
				},
			},
			...
			TheseusAboutFraternalBonds01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}You see{#PreviousFormat}? Just as I said! Cover your bovine ears, Asterius, for this monstrosity would poison us to get the upper hand!"
				},
			},
			...
			TheseusAboutManyBattles01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"And {#DialogueItalicFormat}I{#PreviousFormat}'ve had it with {#DialogueItalicFormat}you{#PreviousFormat}! Now, come, Asterius, let's shut this blackguard up! Or shut him {#DialogueItalicFormat}down{#PreviousFormat}, whichever you prefer."
				},
			},
			TheseusAboutManyBattles02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"To {#DialogueItalicFormat}be {#PreviousFormat}destroyed, you mean! I see you plain, monster. You seek the glory of this fight, before this crowd? You yearn for it! Then, you shall have it! Just as often as you please!"
				},
			},
			TheseusAboutPainting01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"So, I am honored even in the lowest pits of hell? And yet, remembered in my carefree youth. Not in the wisdom of my latter days! Well then, remember {#DialogueItalicFormat}this{#PreviousFormat}!"
				},
			},
			...
			TheseusHasWeaponUpgrade01 =
			{
				...
				RequiredWeapon = "SpearWeapon",
				{
					...
					Emote = "PortraitEmoteSparkly",
					Text =
					"What, {#DialogueItalicFormat}ho{#PreviousFormat}, that is a handsome spear you doubtless claimed deceitfully from some more-worthy bearer than yourself!"
				},
				{
					Cue = "/VO/ZagreusField_2755",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, this old thing? How nice of you to notice. It once belonged to the hero, Achilles. A little past your time, but maybe you've heard of him? Seeing as he's {#DialogueItalicFormat}much {#PreviousFormat}more famous than you ever were."
				},
				{
					Cue = "/VO/Theseus_0282",
					Emote = "PortraitEmoteAnger",
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"How {#DialogueItalicFormat}dare {#PreviousFormat}you say such things to me! I was the greatest king of Athens in my day! The tales of my exploits with Asterius and many other challenges shall long outlive whatever comes of {#DialogueItalicFormat}you{#PreviousFormat}!"
				},
			},
			TheseusAboutArthurAspect01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ahh{#PreviousFormat}, well then! I pity whosoever shall lay hands upon that cursed thing, once you are finished with this {#DialogueItalicFormat}testing {#PreviousFormat}of yours. I think that we can make it rather quick!"
				},
			},
			...
			{
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Face us, {#DialogueItalicFormat}filth{#PreviousFormat}! However many times it takes, until you cannot stand it any longer!"
				},
			},
			TheseusMiscStart24 =
			{
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			MinotaurExtremeMeasures01 =
			{
				...
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 3 },
				{
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"Observe this gleaming coat of bronze with which I am adorned, now, short one. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Your doing, as I'm to understand."
				},
				{
					Cue = "/VO/ZagreusField_2897",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			MinotaurExtremeMeasures02 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"Dress code. {#DialogueItalicFormat}<Snort> {#PreviousFormat}I, too, follow a code. And it's a code that strictly states I cannot let you pass without a fight."
				},
			},
			MinotaurExtremeMeasuresWinStreak01 =
			{
				...
				},
				{
					...
					PreLineFunctionName = "StartBossRoomMusic",
					Text =
					"No. {#DialogueItalicFormat}<Snort> {#PreviousFormat}King Theseus is occupied with preparations of his own. You are my good acquaintance now."
				},
			},
			...
			MinotaurAboutGilgameshAspect01 =
			{
				...
				RequiredFalsePlayed = { "/VO/ZagreusHome_3490" },
				{
					...
					Text =
					"You haven't spoken to your fist-weapons yet, have you, short one? {#DialogueItalicFormat}'I see you overcome the wild and make peace with death.' {#PreviousFormat}That's what you're supposed to tell them. I'm sure of it."
				},
				{
					Cue = "/VO/ZagreusField_4265",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
		...
		BossPresentationIntroTextLineSets =
		{
			...
			MinotaurDefeatedTheseus01 =
			{
				...
				},
				{
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"I see you plain, short one. I, too, was born of darkness. But, I chose the path of light. Even in death, it was not too late. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Not even for a monster, such as I. I trust your deaths will likewise be enlightening."
				},
			},
			...
			MinotaurAutograph01 =
			{
				...
				EndWait = 0.6,
				{
					...
					Text =
					"{#DialogueItalicFormat}Ah{#PreviousFormat}. I sense another furious battle here awaits us, short one. Although you're more inquisitive than usual..."
				},
				{
					Cue = "/VO/ZagreusField_1758",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Uhh{#PreviousFormat}, oh! It's just, I have an odd request. You see, the god of slumber, Hypnos? Colleague of mine. Huge fan. He's in desperate need of your autograph. Little personalized message? I don't suppose you'd be so kind. It'd mean a lot to him."
				},
				{
				...
				{
					Cue = "/VO/Storyteller_0229",
					IsNarration = true,
					PreLineWait = 0.4,
					Text =
					"{#DialogueItalicFormat}The god-forsaken Minotaur impresses then upon a parchment a brief message to the god of sleep, and gives it to the favor-asking Prince."
				},
				{
			...
			MinotaurAboutFistWeapon01 =
			{
				...
				RequiredWeapon = "FistWeapon",
				{
					...
					Text =
					"{#DialogueItalicFormat}Huh{#PreviousFormat}. You mean to fight with me bare-handed this time, short one? I'm not ashamed to say the Champion himself defeated me in such a manner back when we drew breath."
				},
				{
					Cue = "/VO/ZagreusField_3437",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			MinotaurAboutSkelly01 =
			{
				...
				RequiredKills = { Minotaur = 10 },
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Say, you're from Crete, originally, aren't you, Asterius? I know this is a stretch, but... I don't suppose you ever heard of a commander by the name of {#DialogueItalicFormat}Schelemeus{#PreviousFormat}? Captain of the Cretan second fleet, something like that?"
				},
				{
					Cue = "/VO/Minotaur_0307",
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"The king of Crete commanded the greatest navy in the world. Even I knew that, having never seen the light of day, the ships, the sea. {#DialogueItalicFormat}Schelemeus{#PreviousFormat}, huh...? I might have heard the name. So what?"
				},
				{
					Cue = "/VO/ZagreusField_4261",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					Emote = "PortraitEmoteSurprise",
					PreLineAnim = "ZagreusTalkDenialStart",
			...
			MinotaurRevealsGilgameshAspect01 =
			{
				...
				},
				{
					...
					Text =
					"No. I dreamed. And in my dream, there was something I had to tell you. Rather... something you have to tell the weapons you wear on your hands. Tell them, {#DialogueItalicFormat}'I see you overcome the wild and make peace with death.'{#PreviousFormat}"
				},
				{
					Cue = "/VO/ZagreusField_4263",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusInteractionThoughtful",
					PreLineAnimTarget = "Hero",
			...
			MinotaurLowHealth01 =
			{
				...
				RequiredTextLines = { "MinotaurEncounter01" },
				{
					...
					Text =
					"I smell the blood on you, short one. {#DialogueItalicFormat}<Snort> {#PreviousFormat}You are severely wounded. This will not be a fair fight."
				},
				{
					Cue = "/VO/ZagreusField_1762",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
		...
		BossPresentationTextLineSets =
		{
			MinotaurEncounter01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Short one{#PreviousFormat}?! That's a low blow, sir. I thought you were the big-honorable type."
				},
				{
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"You mock my sense of honor. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Common tactic. Now prepare."
				},
			},
			MinotaurEncounter02 =
			{
				...
				},
				{
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"To step into my chamber is to challenge me. {#DialogueItalicFormat}<Snort> {#PreviousFormat}It is a custom since the time I lived and breathed in darkness. I will send you into such a darkness now."
				},
			},
			MinotaurEncounter03 =
			{
				...
				},
				{
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"I do not jab. {#DialogueItalicFormat}<Snort> {#PreviousFormat}All of my strength goes into every strike. Observe."
				},
			},
			MinotaurEncounter04 =
			{
			...
			MinotaurEncounter05 =
			{
				...
				RequiredAnyTextLines = { "MinotaurEncounter04" },
				{
					...
					Text =
					"It would seem {#DialogueItalicFormat}<Snort> {#PreviousFormat}that the time for additional {#DialogueItalicFormat}fun {#PreviousFormat}has arrived."
				},
				{
					Cue = "/VO/ZagreusField_1752",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			MinotaurEncounter06 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You know, you hurt me with this '{#DialogueItalicFormat}short one{#PreviousFormat}' business almost as much as with that axe. Why isn't Theseus '{#DialogueItalicFormat}short one{#PreviousFormat}'? We're the same height!"
				},
				{
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"Good. {#DialogueItalicFormat}<Snort> {#PreviousFormat}It feels as though I haven't crushed the life from anything in ages."
				},
			},
			MinotaurMiscStart09 =
			{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"Thank you, short one. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Few in Elysium dare challenge me repeatedly."
				},
			},
			MinotaurMiscStart12 =
			{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"They said you were headed this way. {#DialogueItalicFormat}<Snort> {#PreviousFormat}I said I'd stop you. Though, we'll see."
				},
			},
			MinotaurMiscStart23 =
			{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"Told the king I'd try to stop you on the way. He thought I'd have no trouble. {#DialogueItalicFormat}<Snort> {#PreviousFormat}We'll see."
				},
			},
			MinotaurMiscStart27 =
			{
			...
			{
				{
					...
					PreLineWait = 0.35,
					Text =
					"You know what it takes to leave this chamber alive, short one. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Come on and fight."
				},
			},
			...
			MinotaurMiscStartExtremeMeasures03 =
			{
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 3 },
				{
					...
					PreLineThreadedFunctionName = "PlayPreLineTauntAnimFromSource",
					Text =
					"This armor's heavy. But makes me even faster than before. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Watch."
				},
			},
			...
			MinotaurMiscStartWinStreak03 =
			{
				...
				},
				{
					...
					PreLineWait = 0.35,
					Text =
					"Interesting. {#DialogueItalicFormat}<Snort> {#PreviousFormat}Most never challenge me again once I destroy them."
				},
			},
		...
		BossPresentationOutroTextLineSets =
		{
			...
			MinotaurGilgameshAspectOutro01 =
			{
				...
				RequiredTextLines = { "MinotaurRevealsGilgameshAspect01" },
				{
					...
					Text =
					"{#DialogueItalicFormat}Urgh{#PreviousFormat}... the might of Gilgamesh... I understand it now. But I won't make his friend's mistake. We'll fight again."
				},
			},
	...
	Hades =
	{
		...
		{
			{
				...
				-- Beaten... once... again...
				{
					Cue = "/VO/HadesField_0494",
					RequiredPlayed = { "/VO/HadesField_0139" },
					RequiredTextLines = { "Ending01" },
					ConsecutiveDeathsInRoom =
		...
		BossPresentationSuperPriorityIntroTextLineSets =
		{
			LordHadesAboutPersephoneMeeting01 =
			{
				...
				{
					Cue = "/VO/HadesField_0404",
					PreLineWait = 0.35,
					Text =
					"You now know that, even if you are able to surpass me, you shall ultimately perish, soon enough. And yet you still persist! Utterly senseless."
				},
				{
					Cue = "/VO/ZagreusField_3680",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I found her, Father. And I'm going to find Mother again. And again, and again, until I have some answers, finally. She'd like some answers, too, beginning with {#DialogueItalicFormat}why did you never tell her that I lived{#PreviousFormat}? You let her go, and left her to her grief!"
				},
				{
					...
					Text =
					"{#DialogueItalicFormat}Silence{#PreviousFormat}, boy! Save all your ignorant and baseless accusations. You seem incapable of heeding my request that you not blather on about a matter you shall never understand. Then, I shall save my breath for this fight!"
				},
			},
			LordHadesAboutPersephoneMeeting02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Nyx saved me.... So according to the Fates I was never meant to be born, since neither you nor Mother are of the Underworld, something like that? Or was that just another lie you told, to Mother and whoever else?"
				},
				{
					Cue = "/VO/HadesField_0558",
					Emote = "PortraitEmoteFiredUp",
					Text =
					"{#DialogueItalicFormat}Bah! {#PreviousFormat}You think everything a lie. The realm beneath our feet was appointed to me on certain conditions, not that I had much of a choice. Among them: A one-time surface-dweller such as I would never have an heir."
				},
				{
					Cue = "/VO/ZagreusField_4327",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"You don't know anything! Why anyone would {#DialogueItalicFormat}choose {#PreviousFormat}to have a child is a mystery to me. The Fates said I would never have an heir. Perhaps {#DialogueItalicFormat}this {#PreviousFormat}was all they meant."
				},
			},
			LordHadesAboutPersephoneMeeting05 =
			{
				...
				RequiredFalseTextLines = { "PersephoneMeeting09" },
				{
					Cue = "/VO/HadesField_0406",
					PreLineWait = 0.35,
					Text =
					"To think Olympus has been aiding you. You must be so grateful to them for their aid, without which none of this would have been possible."
				},
				{
					Cue = "/VO/ZagreusField_3681",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Yeah, about that. Father, did... did you let Mother go because you feared Olympus would find out? And... not respond well to the circumstances if they did?"
				},
				{
					Cue = "/VO/HadesField_0407",
					Text =
					"{#DialogueItalicFormat}Tsch. {#PreviousFormat}Be grateful they have not found out as yet, for all your meddling. You do not know them as well as you think. Ask yourself why she left Olympus, and how. Or better yet, ask {#DialogueItalicFormat}her{#PreviousFormat}."
				},
				{
					Cue = "/VO/ZagreusField_3682",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Well, she seems quite lovely, so... knowing you, you probably tricked her into signing a pact to come join you, or something. Since you weren't allowed on Olympus, why not have Olympus come to you?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"{#DialogueItalicFormat}Hah{#PreviousFormat}! Surprisingly not distant from the truth. I took her, boy! I took her down with me. Is that what you wish to hear? Does that anger you? Come, bring forth that anger, then!"
				},
			},
			LordHadesAboutPersephoneMeeting06 =
			{
				...
				RequiredFalseTextLines = { "PersephoneMeeting09" },
				{
					Cue = "/VO/HadesField_0409",
					PreLineWait = 0.35,
					Text =
					"So, boy. Did you ask her? About how she came to join me in the Underworld. Did you confirm all your suspicions, then?"
				},
				{
					Cue = "/VO/ZagreusField_3683",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You didn't drag her down to hell, yourself, apparently. You're not going to tell me who did, though I can well imagine. Your brothers got to reign forever on Olympus, while you got sent down into the Underworld. So they gave you a consolation prize... didn't they?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"You make such accusations, knowing next to nothing. Careless as ever. Poseidon had nothing to do with it! He knows even less than you. If you value her existence or your own, you would be wise to keep it that way. And to turn back!"
				},
			},
			LordHadesAboutPersephoneMeeting07 =
			{
				...
				RequiredFalseTextLines = { "PersephoneMeeting09" },
				{
					Cue = "/VO/HadesField_0411",
					PreLineWait = 0.35,
					Text =
					"...She was the Queen. Queen of the Underworld! My Queen. Commanding reverence, and awe, and fear. She was not just... what was the term you used? A {#DialogueItalicFormat}consolation prize{#PreviousFormat}? You are as disrespectful to her as you are to me."
				},
				{
					Cue = "/VO/ZagreusField_3684",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					Emote = "PortraitEmoteFiredUp",
					Text =
					"Oh, what would you even know?! You claim so much respect for her, yet you didn't even respect her enough to tell her what happened after she left! But... what am I saying... I know you love her, still, Father. That best explains all the terrible choices you've made."
				},
				{
					...
					PreLineWait = 0.35,
					Text =
					"...All the terrible choices I've made. By the time you have existed for as long as I have, pray you will have made fewer. Although I fear you shall surpass me in at least this one regard."
				},
			},
			...
			LordHadesBeforePersephoneReturn01 =
			{
				...
				{
					Cue = "/VO/HadesField_0413",
					PreLineWait = 0.35,
					Text =
					"...I have done virtually everything within my power to prevent this. All of it... for nothing. The Fates were not content to saddle me within the earth; they mock me, still."
				},
				{
					Cue = "/VO/ZagreusField_3685",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Maybe they just think you're in the wrong. And that you're an obstinate, overbearing, miserable excuse for a husband and father. Don't you understand I'm trying to fix the problems you caused? Since you're so unwilling to do it yourself."
				},
				{
					...
					PreLineWait = 5.3,
					Text =
					"You're right. I was unwilling. I made my choices, in all this. I loved her, yes. I loved her terribly. But now... it seems I am merely delaying the inevitable. Go, then. Go to her. But, should harm befall her... I shall bring my worst wrath upon whomever is to blame... including you."
				},
				{
			...
			LordHadesPostEnding01 =
			{
				...
				{
					Cue = "/VO/HadesField_0421",
					PreLineWait = 0.35,
					Text =
					"{#DialogueItalicFormat}Heh. {#PreviousFormat}Confronting you like this... it's different now. Still... it is a responsibility, just as before. There is to be no escape from my realm. Ultimately, I must see to that, myself."
				},
				{
					Cue = "/VO/ZagreusField_3688",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"That's the spirit, Father! As for me, I find the candor of our interactions here to be rather refreshing, I must say. Especially the interactions between my weapons and your physique. You're tough, but you're an easy target."
				},
				{
					...
					PreLineWait = 0.35,
					Text =
					"And you are scrawny, though slippery, blast you. All that pent-up rage behind your smiling words... come, unleash it once again. I expect you to go all out. To the death!"
				},
			},
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			LordHadesHasGuanYuAspect01 =
			{
				...
				RequiredWeapon = "SpearWeapon",
				{
					Cue = "/VO/HadesField_0325",
					PreLineWait = 0.35,
					Text =
					"What have you done with my ancient weapon, boy? I sense Varatha's form there in your feeble grip, but... there's some garish power you've awakened in it, haven't you?"
				},
				{
					Cue = "/VO/ZagreusField_2970",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, just took a splash of Titan Blood at the right time was all. There's more to your ancient weapon than you gave it credit for, I guess. Though let's not keep it waiting, no?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"No, let's not. Gigaros is the mightier weapon, with none of the treacherous past. It needs no fanciful shape-shifting tricks to run you through. Behold!"
				},
			},
			LordHadesHasArthurAspect01 =
			{
				...
				RequiredWeapon = "SwordWeapon",
				{
					Cue = "/VO/HadesField_0388",
					PreLineWait = 0.35,
					Text =
					"I never had any respect for Stygius, that blade you bear. Perhaps unfairly, due to Brother Poseidon's sloppy form when once he wielded it. But now it seems quite different in your care."
				},
				{
					Cue = "/VO/ZagreusField_3422",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I think we've grown quite close to one another, yes. Enough to where I've come to know a different side of this fine blade right here. This is the aspect of some Arthur fellow! Maybe the two of you could get acquainted properly?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"{#DialogueItalicFormat}Arthur! {#PreviousFormat}No name either of gods or kings of any realm I know. Then, introduce us, as you say! To this new amateur, to whom your blade rendered its services."
				},
			},
			LordHadesHasRamaAspect01 =
			{
				...
				{
					Cue = "/VO/HadesField_0390",
					PreLineWait = 0.35,
					Text =
					"The bow is the weapon of a coward, boy. I said so even to Hera's face. I'm unsurprised that you are drawn to it, and yet... something has changed about it, I can tell."
				},
				{
					Cue = "/VO/ZagreusField_3518",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What, you mean that Coronacht has taken on the aspect of a divine preserver person of some sort, of whom I've seen mere glimpses but seems definitely very capable, and really rather brave?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"I know not why the old Infernal Arms endear themselves to you. And, I entirely care not in whose weakling aspect you bring them forth, only to fall to me."
				},
			},
			LordHadesHasBeowulfAspect01 =
			{
				...
				{
					Cue = "/VO/HadesField_0399",
					PreLineWait = 0.35,
					Text =
					"There you are, bearing my brother's blasted shield... flaunting it about so recklessly. Though, what have you done to it, now?"
				},
				{
					Cue = "/VO/ZagreusField_3581",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Not much, really, besides awakening the aspect of a supposedly unstoppable, dragon-slaying warrior called Beowulf. If it has the power to protect him against a giant lizard, I figure it may help me against you."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"You presently shall find I'm no mere giant lizard, boy. Though we shall see whether this Beowulf is any help to you."
				},
			},
			LordHadesHasGilgameshAspect01 =
			{
				...
				RequiredWeapon = "FistWeapon",
				{
					Cue = "/VO/HadesField_0618",
					PreLineWait = 0.35,
					Text =
					"Resorting to mere fisticuffs with me... though, how you got Malphon to look like that, I've no idea. Pray tell, whose monstrous claws are those? A manticore's?"
				},
				{
					Cue = "/VO/ZagreusField_4335",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"These claws, I'll have you know, Father, belonged once to an ancient god-king known as Gilgamesh. You ever meet?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"{#DialogueItalicFormat}Hrm{#PreviousFormat}. Provided he was flesh and blood at some point, then he resides within my realm. Presumably within Elysium somewhere, sadly bereft of his manticore claws, thanks to you. Come, show me what they can do."
				},
			},
			...
			LordHadesMiscEncounter05 =
			{
				...
				RequiredAnyTextLines = { "LordHadesEncounter01", "LordHadesEncounter01_B" },
				{
					Cue = "/VO/HadesField_0143",
					PreLineWait = 0.35,
					Text =
					"{#DialogueItalicFormat}Ah{#PreviousFormat}, but there you are, boy, finally. Despite my knowing you are always late for everything, here you've outdone yourself by quite some time."
				},
				{
					Cue = "/VO/ZagreusField_2275",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
			...
			LordHadesMiscEncounter03 =
			{
				...
				RequiredAnyTextLines = { "LordHadesEncounter01", "LordHadesEncounter01_B" },
				{
					Cue = "/VO/HadesField_0018",
					PreLineWait = 0.35,
					Text =
					"This cold white substance falling slowly from the heavens. Snow, they call it. Look carefully upon each fleck. Tiny crystals! But structurally weak. They melt! This surface realm... it is held up by mine."
				},
				{
					Cue = "/VO/ZagreusField_2228",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"If you're quite finished teaching me about this snow phenomenon, can we get on with brutally trying to kill each other, here?"
				},
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"You wish to have your mortal-colored blood spill once again upon this bed of snow, then fine. Let us proceed."
				},
			},
			LordHadesMiscEncounter06 =
			{
				...
				{
					Cue = "/VO/HadesField_0146",
					PreLineWait = 0.35,
					Text =
					"You still have yet to see the sun itself. You know only the light of Ixion, but the sun? It is positively blinding. Hideous."
				},
				{
					Cue = "/VO/ZagreusField_2276",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"It has been snowy nightfall every single time now that you mention it. I didn't know it snowed so much up here."
				},
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"It hasn't always. But, that's of no consequence to us. Especially when there's a raging battle to be fought."
				},
			},
			...
			LordHadesPostEpilogue01 =
			{
				...
				RequiredTextLines = { "OlympianReunionQuestComplete" },
				{
					Cue = "/VO/HadesField_0423",
					PreLineWait = 0.35,
					Text =
					"If you are here, then... the Olympians must still be lending you their aid. Just as before! I scarce believe the Queen's preposterous idea worked. That all it took to settle an old score was a blasted family feast."
				},
				{
					Cue = "/VO/ZagreusField_3689",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Come on, Father, even you must have enjoyed that feast to some extent. We ought to do it more often! Good thing you trusted Mother's judgment on that one. So, then, to the death, once more?"
				},
				{
		...
		BossPresentationIntroTextLineSets =
		{
			LordHadesEncounter01 =
			{
				...
				{
					Cue = "/VO/HadesField_0006",
					PreLineWait = 0.35,
					Text =
					"...I never grew accustomed to the air, up here. It gusts senselessly whichever way it pleases. I suppose you must prefer it to the stillness of the air below."
				},
				{
					Cue = "/VO/ZagreusField_2224",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You know, you're right. The air up here seems pretty good so far. But I will reserve judgment till I've had my fill. I have to say, though, Father: The Helm of Darkness suits you. I'm touched you'd dust it off on my account."
				},
				{
					Cue = "/VO/HadesField_0145",
					Text =
					"It should not have had to come to this. For all your antics with me and around the House, I always kept my temper, have I not? Unlike you."
				},
				{
					Cue = "/VO/ZagreusField_2307",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
				...
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"We're gods, boy. Killing one another is our lot. Although, I always thought I was above it. I told you that you cannot leave this place. It seems I must enforce my rules myself. I'm sending you home, now."
				},
			},
			...
			LordHadesEncounter_YouDefeated01 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0022",
					PreLineWait = 0.35,
					Text =
					"You know now what you're doing here is without any purpose whatsoever. Even if I don't slay you myself, you'll simply perish when you cross that threshold there. And yet you still persist?"
				},
				{
					Cue = "/VO/ZagreusField_2230",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"I do. Besides, making these treks helps pass the time during the ongoing Underworld renovations. And I'll be in tiptop shape once they're complete!"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"Would that we had a little more support; the renovations could have been complete by now! As ever, you think only of yourself. But if you must insist like this, then you will find me waiting for you once you get here. Every single time."
				},
			},
			...
			LordHadesEncounter_DoneTalking01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Beats having to toil away under your overbearing supervision. And besides, as you may be aware, I've recently made up my mind to leave this place."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"{#DialogueItalicFormat}Eughh{#PreviousFormat}... utterly incorrigible. When next we meet here, then, we'll keep it brief. I have grown weary of our aimless conversations. Now prepare!"
				},
			},
			...
			LordHadesHadesKeepsakeReaction01 =
			{
				...
				{
					Cue = "/VO/HadesField_0620",
					PreLineWait = 0.35,
					Text =
					"You bear the Sigil of the Dead. I wear the Helm of Darkness. Even devoid of artifacts as these, we fight here without witnesses... in shadow."
				},
				{
					Cue = "/VO/ZagreusField_4333",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"If only everybody knew you had a mighty son most capable of cutting you down to size, with or without the ability to vanish suddenly."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"A very boastful son, who often thinks too much of his ability. Come, then! I'll make you vanish suddenly."
				},
			},
			LordHadesPersephoneKeepsakeReaction01 =
			{
				...
				{
					Cue = "/VO/HadesField_0622",
					PreLineWait = 0.35,
					Text =
					"...That pomegranate blossom... I caught its subtle scent as you approached. The Queen has her mother's strength. And much more self control."
				},
				{
					Cue = "/VO/ZagreusField_4334",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What, you're afraid of a little flower, now, Father? One that imbues me with the fiercest might of Olympus, granted, but still! It looks harmless, at least."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"I fear your little flower there much more than you. The Queen and her mother... they possess power over life. Thus, power over death."
				},
			},
			...
			LordHadesExtremeMeasures02 =
			{
				...
				{
					Cue = "/VO/HadesField_0613",
					PreLineWait = 0.35,
					Text =
					"Extreme measures permitted, even still? You must have forgotten to change the conditions of your Pact of Punishment."
				},
				{
					Cue = "/VO/ZagreusField_4331",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Wasn't an oversight. You're strong, Father. I want to be as strong, and more. Not that I'm taking after you, or anything."
				},
				{
					...
					PreLineWait = 0.35,
					Text =
					"You wish to test yourself against the full extent of my wrath, then very well. You have earned that right. Besides yourself, only the Titans have. Now, then... {#DialogueItalicFormat}attack{#PreviousFormat}!"
				},
			},
			LordHadesExtremeMeasures03 =
			{
				...
				{
					Cue = "/VO/HadesField_0615",
					PreLineWait = 0.35,
					Text =
					"You vanquished me... even when I threw everything I had at you, and more. I fought you as I fought the Titans themselves, and still I failed."
				},
				{
					Cue = "/VO/ZagreusField_4332",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, don't take it so hard, Father. There's always next time, right? Meaning, this time. Maybe I won't be so fortunate."
				},
				{
					...
					PreLineWait = 0.35,
					Text =
					"Of that, I am most certain. Come, let us see the limits of our abilities, then. I warn you: I shall hold nothing back. To the death!"
				},
			},
			...
			LordHadesNoBoonsReaction01 =
			{
				...
				{
					Cue = "/VO/HadesField_0659",
					PreLineWait = 0.35,
					Text =
					"...Nary a whif of Mount Olympus on you, this time. How is it that you clambered all this way, without the generous support of your dear family? Doubtless you merely purged their blessings for some coin."
				},
				{
					Cue = "/VO/ZagreusField_4643",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
			...
			LordHadesNoBoonsReaction02 =
			{
				...
				{
					Cue = "/VO/HadesField_0561",
					PreLineWait = 0.35,
					Text =
					"Odd. No stink of Olympus on you, this time. Have you truly come all this way without assistance from your relatives? Or were you overzealous at a Pool of Purging?"
				},
				{
					Cue = "/VO/ZagreusField_4668",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Wouldn't you like to know? Not even Nyx believed that I could come this far without aid from the Olympians. Maybe I just have a knack for proving everybody wrong."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"You have a {#DialogueItalicFormat}knack {#PreviousFormat}for being struck down in various, ignoble ways, that much is certain. Come, then! Show me what you, yourself, can do!"
				},
			},
			...
			LordHadesAboutFishing01 =
			{
				...
				IsIdAlive = 553255,
				{
					Cue = "/VO/HadesField_0689",
					PreLineWait = 0.35,
					Text =
					"Be still. These waters... teeming with Poseidon's river denizens. That one there, before me... it's been taunting me, I think, for quite some time."
				},
				{
					Cue = "/VO/ZagreusField_4675",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You offering to take me {#DialogueItalicFormat}fishing{#PreviousFormat}, Father? Sounds more pleasant than having you slaughter me again, or the other way around."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"You mistook my meaning. First, {#DialogueItalicFormat}you {#PreviousFormat}shall have my spear. Then, that thing shall, if it has not yet come to its senses. Though, if you vanquish me, I'm certain your uncle shall not mind if you extract it, yourself."
				},
			},
			...
			LordHadesPactHighHeatReaction01 =
			{
				...
				RequiredActiveShrinePointsMin = 25,
				{
					Cue = "/VO/HadesField_0657",
					PreLineWait = 0.35,
					Text =
					"It is a testament to the awful might of Demeter that, even with the surge of heat created by the Pact of Punishment you toy with recklessly, this place remains a frozen waste."
				},
				{
					Cue = "/VO/ZagreusField_4642",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"The Pact did make the road here a little more fraught than usual. But if it couldn't stop me, I can't imagine it could stop Demeter."
				},
				{
			...
			LordHadesWinterCurseReaction01 =
			{
				...
				{
					Cue = "/VO/HadesField_0661",
					PreLineWait = 0.35,
					Text =
					"Enjoying the delicate warmth of the surface, b-- Zagreus? Apparently, the generosity of the goddess of seasons knows no bounds."
				},
				{
					Cue = "/VO/ZagreusField_4644",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Does feel a bit different, maybe. Though, Demeter said something about how this spot, in particular, would remain bereft of warmth, as a reminder. Do you think she knows what happened with Mother, really?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"Demeter may harbor vengeful feelings and suspicions, but she is no fool. Experience teaches us to know when to quit. Though, evidently, that is a lesson you have yet to learn."
				},
			},
			...
			LordHadesHasWeaponUpgrade01 =
			{
				...
				{
					Cue = "/VO/HadesField_0246",
					PreLineWait = 0.35,
					Text =
					"Varatha... I recognize its presence, now. That's not just any three-pronged lance you wield. I could never stand to look at it, once my brothers and my sisters and myself... once our foul work was done."
				},
				{
					Cue = "/VO/ZagreusField_2465",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You mean once you'd chopped up your cruel and overbearing Titan parents, right? Shame you threw it out. It's quite useful."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"Perhaps the Fates decided that its wielders ought to all eventually wind up on its receiving end. Come, then! Let us see what the great Achilles has taught you."
				},
			},
			LordHadesHasWeaponUpgrade02 =
			{
				...
				{
					Cue = "/VO/HadesField_0242",
					PreLineWait = 0.35,
					Text =
					"So! You think that you can vanquish me with my fool brother's old, forgotten blade. Poseidon was never any good with Stygius. Grew envious of my spearwork. Now he's famous for that fork of his! Always taking credit where none is due."
				},
				{
					Cue = "/VO/ZagreusField_2466",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Must be hard, knowing that everybody's going to think you learned your spearwork from Poseidon, not the other way around. As for Stygius, I can assure you it's in good hands now."
				},
				{
			...
			LordHadesHasWeaponUpgrade03 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What? I haven't even started to insult you here yet, Father. Flustered by the old Shield of Chaos, then?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"Doubtless Zeus does not even remember wielding it. I never should have relied on him for anything after that! Then, come. Let's see if you're any better with it than your great uncle."
				},
			},
			...
			LordHadesAboutEternalWinter01 =
			{
				...
				{
					Cue = "/VO/HadesField_0322",
					PreLineWait = 0.35,
					Text =
					"{#DialogueItalicFormat}Hrm{#PreviousFormat}. It grew distinctly colder just as you arrived. So {#DialogueItalicFormat}Demeter {#PreviousFormat}has been in contact with you, then. That witch. Tell me how much she knows."
				},
				{
					Cue = "/VO/ZagreusField_2968",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What? I don't... wait, this everlasting winter, it's her doing, isn't it? Why? Don't mortals die when it's cold? Sounds like a lot of extra work for you."
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"Then you are ignorant. Keep it that way, with her. Lest you risk everything, you understand? The consequences would be far worse than a foul stretch of weather. But, enough talk, now."
				},
			},
			LordHadesAboutEternalWinter01_B =
			{
				...
				RequiredGodLoot = "DemeterUpgrade",
				{
					...
					PreLineWait = 0.35,
					Text =
					"Hrm. It grew distinctly colder just as you arrived. So Demeter has been in contact with you, then. That witch. Tell me how much she knows."
				},
				{
					Cue = "/VO/ZagreusField_2969",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"She lost her daughter... who's my mother. But, Demeter still thinks I'm Nyx's son, and... what have you done, Father? This everlasting winter, it's her doing, isn't it? Freezing mortals to death. Why don't you stop this?"
				},
				{
					...
					PreContentSound = "/Leftovers/Menu Sounds/TextReveal3",
					Text =
					"The two of you know nothing, then, it seems. Keep it that way, especially with her. Lest you risk everything, you understand? The consequences would be far worse than a foul stretch of weather. But, enough talk, now."
				},
			},
		},
		...
		BossPresentationTextLineSets =
		{
			LordHadesMiscEncounter01 =
			{
				...
				{
					Cue = "/VO/HadesField_0004",
					PreLineWait = 0.35,
					Text =
					"...The sea... the heavens, and the earth. All of this belongs to my brothers. We are their kin by birth. But we are foreigners in their country."
				},
				{
					Cue = "/VO/ZagreusField_2173",
					Portrait = "Portrait_Zag_Serious_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart",
					PreLineAnimTarget = "Hero",
			...
			LordHadesMiscEncounter02 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0016",
					PreLineWait = 0.35,
					Text =
					"There was a time when Cerberus would never have permitted any soul to exit through that gateway there behind you."
				},
				{
					Cue = "/VO/ZagreusField_2227",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Oh, that can't possibly be true! What about Orpheus, Theseus, Heracles, Odysseus? Countless tales of brave men delving into the Underworld, then leaving whence they came!"
				},
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"They left on my authority alone. Nor did they take for granted my good graces. You believe you are entitled simply to walk out of here. From your birthright and your responsibilities! But I am here to tell you, {#DialogueItalicFormat}no{#PreviousFormat}."
				},
			},
			...
			LordHadesMiscEncounter04 =
			{
				...
				RequiredTextLines = { "LordHadesMiscEncounter01" },
				{
					Cue = "/VO/HadesField_0020",
					PreLineWait = 0.35,
					Text =
					"My brothers and my sisters and myself. We, too, wanted to slay our parents. The Titans. Bastards. And worse."
				},
				{
					Cue = "/VO/ZagreusField_2229",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"And you succeeded. Chopped up some of them into many tiny bits, and sprinkled them throughout the pits of Tartarus so that they can't regenerate! Or so I hear. Inspiring, really!"
				},
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"We had no recourse at the time, save to collaborate. Developed a specific plan, and saw it through. And, the Titans...? You think me cruel, yet know nothing of cruelty. But, here, you want something to hate, then have it!"
				},
			},
			...
			LordHadesMiscEncounter07 =
			{
				...
				RequiredTextLines = { "LordHadesMiscEncounter01" },
				{
					Cue = "/VO/HadesField_0148",
					PreLineWait = 0.35,
					Text =
					"I must admit to something, boy. Achilles taught you reasonably well. I expected that if anyone could train you into martial competence, it would be him."
				},
				{
					Cue = "/VO/ZagreusField_2310",
					Portrait = "Portrait_Zag_Default_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Though you didn't expect that, one day, I would end up using everything I learned from him against {#DialogueItalicFormat}you{#PreviousFormat}."
				},
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"I anticipate more than you know. But Achilles merely practiced against mortals. Now, you practice against {#DialogueItalicFormat}me{#PreviousFormat}."
				},
			},
		},
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			{
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"The heavens and the seas belong to my brothers; but know that you are still in {#DialogueItalicFormat}my {#PreviousFormat}domain."
				},
			},
			...
			LordHadesPostEndingStart05 =
			{
				RequiredTextLines = { "Ending01" },
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"You have circumvented all of my security measures again. But can you get through {#DialogueItalicFormat}me{#PreviousFormat}?"
				},
			},
			...
			LordHadesPostEndingStart08 =
			{
				RequiredTextLines = { "Ending01" },
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Bah{#PreviousFormat}! Not one of my overseers managed to stop you, again? Must I do everything myself?"
				},
			},
			...
			LordHadesPostEndingStart14 =
			{
				RequiredTextLines = { "Ending01" },
				{
					...
					PostLineFunctionName = "StartFinalBossRoomMusic",
					Text =
					"{#DialogueItalicFormat}Ah{#PreviousFormat}, there you are, boy! I was beginning to think I'd need a thicker cloak."
				},
			},
		...
		BossPresentationNextStageTextLineSets =
		{
			LordHadesR1FirstWin =
			{
				...
				{
					Cue = "/VO/HadesField_0010",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					Text =
					"...{#DialogueItalicFormat}Tsch{#PreviousFormat}. To have been brought this low... by my own ungrateful child. I would expect such treatment from my brothers, but from you...? {#DialogueItalicFormat}Nrrrgghhh{#PreviousFormat}...."
				},
			},
			...
			LordHadesNextStageMisc05 =
			{
				...
				RequiredTextLines = { "LordHadesR1FirstWin" },
				{
					Cue = "/VO/HadesField_0035",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					Text =
					"...{#DialogueItalicFormat}Hmph{#PreviousFormat}. All right, then, boy. You've stirred my anger suitably, by now."
				},
			},
			...
			LordHadesFinalStage01 =
			{
				...
				{
					Cue = "/VO/HadesField_0688",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 1.0 },
					Text =
					"{#DialogueItalicFormat}Urgh{#PreviousFormat}... no... I'm... not... finished... with you... {#DialogueItalicFormat}yet{#PreviousFormat}!! "
				},
			},
		},
		...
		BossPresentationOutroTextLineSets =
		{
			...
			LordHadesDefeated01 =
			{
				...
				RequiredFalseTextLines = { "PersephoneFirstMeeting" },
				{
					Cue = "/VO/HadesField_0011",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 9.3 },
					Text =
					"I... how... you.... Go. Go, then. {#DialogueItalicFormat}Go{#PreviousFormat}!! Get out of here! Get out!"
				},
				{
					Cue = "/VO/ZagreusField_2176",
					Portrait = "Portrait_Zag_Serious_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
				...
				{
					Cue = "/VO/HadesField_0012",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					Text =
					"...Wait. Wait, just... if you... if you find her. If you somehow find her? Tell her something for me, tell her... Tell her Cerberus is doing very well."
				},
				{
					Cue = "/VO/ZagreusField_2177",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkDenialStart",
					PreLineAnimTarget = "Hero",
					...
					PostLineAnimTarget = "Hero",
					Text =
					"What? Wait. I don't think I owe you any favors, here. Though, answer me one question, and I'll give it some thought, how's that?"
				},
				{
					Cue = "/VO/HadesField_0014",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					Text = "...I know your question, boy. But, ask it anyway."
				},
				{
					Cue = "/VO/ZagreusField_2214",
					Portrait = "Portrait_Zag_Serious_01",
					Speaker = "CharProtag",
					Text = "Persephone. My mother. Why did she leave?"
				},
				{
					Cue = "/VO/HadesField_0015",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 1.8 },
			...
			LordHadesDefeated02 =
			{
				...
				RequiredTextLines = { "PersephoneFirstMeeting" },
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You're not going to cooperate with me on this, are you? Even now, knowing Mother wants to see me again?"
				},
				{
					Cue = "/VO/HadesField_0560",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 1.0 },
					Text =
					"{#DialogueItalicFormat}Urgh{#PreviousFormat}! Blast you... you shall ruin everything... with all your damnable questions!"
				},
				{
					Cue = "/VO/ZagreusField_4325",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
			...
			LordHadesChaosSurfaceQuestDefeat01 =
			{
				...
				{
					Cue = "/VO/HadesField_0403",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 2.3 },
			...
			LordHadesExtremeMeasuresDefeat01 =
			{
				...
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 4 },
				{
					Cue = "/VO/HadesField_0624",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.35,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 1 },
					Text =
					"{#DialogueItalicFormat}Urgh{#PreviousFormat}.... {#DialogueItalicFormat}<Gasp> {#PreviousFormat}How... I... I went all out! And still...?"
				},
			},
		},
		...
		BossPresentationOutroRepeatableTextLineSets =
		{
			...
			{
				{
					Cue = "/VO/HadesField_0209",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.8 },
			...
			LordHadesMiscDefeat04 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0211",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 3 },
			...
			LordHadesMiscDefeat05 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0212",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.6 },
					Text =
					"{#DialogueItalicFormat}Ungh... {#PreviousFormat}The world you seek out there... it's even crueler than the one you know."
				},
			},
			LordHadesMiscDefeat06 =
			{
				{
					Cue = "/VO/HadesField_0213",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.5 },
			...
			LordHadesMiscDefeat07 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0214",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 1.0 },
					Text =
					"{#DialogueItalicFormat}Aah, blast{#PreviousFormat}! That you of all my kin would be the one, to do this, to me...."
				},
			},
			LordHadesMiscDefeat08 =
			{
				...
				RequiredFalseTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0215",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
					Text =
					"{#DialogueItalicFormat}Mmph{#PreviousFormat}... No matter how many times you beat me... we're family. There's no escaping that."
				},
			},
			LordHadesMiscDefeat09 =
			{
				{
					Cue = "/VO/HadesField_0247",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
			...
			{
				{
					Cue = "/VO/HadesField_0250",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
					Text =
					"{#DialogueItalicFormat}Rrngh{#PreviousFormat}, you stubborn... you shrug off death as though it means nothing to you...!"
				},
			},
			LordHadesMiscDefeat13 =
			{
				{
					Cue = "/VO/HadesField_0251",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.3,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
			...
			LordHadesMiscDefeat16 =
			{
				...
				{
					Cue = "/VO/HadesField_0254",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.3,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
					Text =
					"{#DialogueItalicFormat}Urgh{#PreviousFormat}... were it not for all my wretched kin upon Olympus, you..."
				},
			},
			...
			LordHadesMiscPostEndingDefeat01 =
			{
				RequiredTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0498",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.3,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
					Text =
					"{#DialogueItalicFormat}Gah{#PreviousFormat}... you have your mother's perseverance. How is it that you got this strong?"
				},
			},
			...
			LordHadesMiscPostEndingDefeat04 =
			{
				RequiredTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0501",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.3,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
					Text =
					"{#DialogueItalicFormat}Nngh{#PreviousFormat}... for a student of Achilles... I fear that you surpass even his skill, by now..."
				},
			},
			LordHadesMiscPostEndingDefeat05 =
			{
				RequiredTextLines = { "Ending01" },
				{
					Cue = "/VO/HadesField_0502",
					Portrait = "Portrait_Hades_Helm_01",
					PreLineWait = 0.3,
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 0.4 },
					Text =
					"{#DialogueItalicFormat}Umphh{#PreviousFormat}... you broke through every one of my defenses, once again..."
				},
			},
		...
		BossPresentationPriorityIntroTextLineSets =
		{
			BossCharonAboutHermesQuest01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You know, Charon, your associate Hermes apparently had a wager with you that I could beat you twice in a row at some point? I'd hate to disappoint him, so... no hard feelings?"
				},
				{
					Cue = "/VO/Charon_0038",
		...
		BossPresentationIntroTextLineSets =
		{
			BossCharonEncounter01 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"{#DialogueItalicFormat}Erm{#PreviousFormat}, Charon, look, I can explain. It's just, I've grown very accustomed to taking stuff throughout my father's realm. I wasn't stealing from you, honestly!"
				},
				{
					Cue = "/VO/Charon_0038",
					PreLineAnim = "CharonTaunt",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 1.2 },
					Emote = "PortraitEmoteAnger",
					Text = "Mmnnn{#DialogueItalicFormat}rraaauuugggghhh{#PreviousFormat}!!"
				},
				{
					Cue = "/VO/ZagreusField_3748",
					Portrait = "Portrait_Zag_Defiant_01",
					Speaker = "CharProtag",
					PreLineFunctionName = "StartCharonBossRoomMusic",
			...
			BossCharonEncounter02 =
			{
				...
				},
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"You're just testing me, here, right, Charon? I mean, when you place a huge sum of coin conspicuously within my reach, what do you expect me to do?"
				},
				{
					Cue = "/VO/Charon_0040",
				...
				},
				{
					...
					PreLineFunctionName = "StartCharonBossRoomMusic",
					Text =
					"Sounds good, mate, when I rob you from now on it's just my way of saying {#DialogueItalicFormat}Charon, I would like to battle you to the death right now for a quick change of pace{#PreviousFormat}."
				},
			},
		...
		BossPresentationOutroTextLineSets =
		{
			BossCharonOutro01 =
			{
				PlayOnce = true,
				{
					Cue = "/VO/Charon_0099",
					PreLineThreadedFunctionName = "PowerWordPresentation",
					PreLineThreadedFunctionArgs = { WaitTime = 4.1 },
			...
			BossCharonHermesQuestComplete01 =
			{
				...
				ConsecutiveClearsOfRoom = { Name = "CharonFight01", Count = 1 },
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Got you, mate! Twice in a row. I guess Hermes wins his little wager with you, then. You tell him I said {#DialogueItalicFormat}hrrrrrnnnggghh{#PreviousFormat}!"
				},
				{
					Cue = "/VO/Charon_0019",
