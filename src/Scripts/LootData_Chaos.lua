local newPortedInteractTextLines = {
	...
	},
	{
		...
		},
		{
			...
			Text =
			"...Merely listen, so it's just like when I get those messages from the Olympians. Wait, you did just prompt me, Master Chaos, didn't you? Or should I have remained silent just now?"
		},
		{
			Cue = "/VO/Chaos_0169",
	...
	},
	{
		...
		},
		{
			...
			PreLineAnimTarget = "Hero",
			Text =
			"I... do not know how to respond to that, exactly, Master Chaos, but, Nyx, yes, she has been aiding me, in my attempts to flee my father's realm."
		},
		{
			Cue = "/VO/Chaos_0278",
			SecretMusicActiveStems = { "ChaosBass" },
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"Master Chaos, it's Persephone, my mother. She's returned! She's chosen to return. So... things feel different, certainly, with her around, although... I didn't feel any sort of shift."
		},
		{
			Cue = "/VO/Chaos_0308",
			UseEventEndSound = true,
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"{#DialogueItalicFormat}Erm{#PreviousFormat}, Master Chaos? The goddess Nyx, she... seems to want to speak with you again. I wonder, would you maybe contact her sometime? She seems convinced it is your move to make if you so choose."
		},
		{
			Cue = "/VO/Chaos_0279",
			SecretMusicActiveStems = { "ChaosBass" },
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"Well, Master Chaos, she can be a little difficult to read at times, but... I got the impression she was quite surprised, even excited to have heard from you again. She said that she would think about how to respond. Or, whether to respond."
		},
		{
			Cue = "/VO/Chaos_0282",
			SecretMusicActiveStems = { "ChaosBass" },
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"Oh, it's just... I sometimes wonder, Master Chaos... if you created all of this, then... who created {#DialogueItalicFormat}you{#PreviousFormat}? What was this place before you arrived?"
		},
		{
			Cue = "/VO/Chaos_0297",
			UseEventEndSound = true,
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"Oh, Master Chaos... you should know I have located her, already. Though where she is, I cannot stay for long. So I am visiting, as often as I can. It's... not unlike our visits here. Only, somehow, even harder to get to where she is."
		},
		{
			Cue = "/VO/Chaos_0306",
			UseEventEndSound = true,
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"Oh! I... Master Chaos, I don't know what to expect from there. But, to be direct with you, if I could leave the Underworld forever... I think I would. Though, I would miss you. Many others here."
		},
		{
			Cue = "/VO/Chaos_0305",
			UseEventEndSound = true,
	...
	},
	{
		...
		},
		{
			...
			PostLineAnimTarget = "Hero",
			Text =
			"Master Chaos, it seems I've developed something of a talent around breaking out of here. Or, there, I mean, the Underworld, so... it's become more of an official role for me, I guess. If escape shouldn't be possible, then someone needs to find the gaps."
		},
		{
			Cue = "/VO/Chaos_0310",
			UseEventEndSound = true,
...
mod.AddNarrativeDataEntries(newPortedInteractTextLines, "TrialUpgrade", "InteractTextLineSets",
	{
		...
		PortraitMappings = { Chaos_ = "ModsNikkelMHadesBiomes_Portrait_Chaos_Default_01" },
	}
)
...
mod.AddNarrativeDataEntries(newModdedInteractTextLines, "TrialUpgrade", "InteractTextLineSets",
	{
		TextLinePriorityType = "InteractTextLinePriorities",
		VoiceBankMappings = { Chaos = { "Modsnikkelmhadesbiomeschaos", "ZagreusField" } },
		CueMappings = { Chaos_ = "Modsnikkelmhadesbiomeschaos_" },
