...
-- We keep a list of specific cues that we want subtitles for Zagreus for - as otherwise playing vanilla would reach the string limit and freeze the game on startup
-- This is only cues that are played outside of dialogues (which are localized separately), meaning only when the player model is Zagreus, which is only the case on the Surface
mod.ZagreusSubtitleCues = {
	-- #region Surface (Rooms, Overlook, Narrator)
	-- RoomData
	ZagreusField_3588 = true,
	ZagreusField_3589 = true,
