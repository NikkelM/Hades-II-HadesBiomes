...
--- Finds a voiceline entry by its Cue within a nested voiceline table and replaces its GameStateRequirements.
--- Searches up to 3 levels deep to handle the nested group structure of voiceline tables.
