...
local nextbiomeShrineSwapMap = {
	...
	BloodlessGrenadier = { Name = "ShadeSwordUnitElite", },
	-- BloodlessGrenadierElite = { Name = "ShadeSwordUnitElite", },
	...
	BloodlessWaveFist = { Name = "ShadeShieldUnitElite", },
	-- BloodlessWaveFistElite = { Name = "ShadeShieldUnitElite", },
