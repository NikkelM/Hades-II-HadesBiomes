...
mod.RoomData.Asphodel = {
				...
				InteractTextLineSets =
				{
					Inspect_B_PreBoss_01_01 =
					{
						...
						EndWait = 0.4,
						{
							...
							Text =
							"{#DialogueItalicFormat}Having traversed the flaming river Phlegethon to gain this vantage point, relentless Zagreus must now confront a foe of unimaginable savagery, who lies ahead, awaiting patiently its time to strike."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_B_Story_01_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}Well past the flaming river escalates the hidden stair toward the most well-guarded, splendorous environment within the Underworld: the heavenly Elysium, home eternal to the greatest souls which ever lived."
						},
					},
				},
			},
	...
	X_Wrapping01 =
	{
		...
		EnterVoiceLines =
		{
			...
			},
			{
				...
				{ Cue = "/VO/ZagreusField_2697", RequireCurrentEncounterCompleted = true,     RequiredPlayed = { "/VO/ZagreusField_2702" } },
				-- Barge of Death again huh.
				{ Cue = "/VO/ZagreusField_2698", RequireCurrentEncounterCompleted = true,     RequiredPlayed = { "/VO/ZagreusField_2702" } },
				-- The Barge of Death is always here for me.
				{ Cue = "/VO/ZagreusField_2699", RequireCurrentEncounterCompleted = true,     RequiredPlayed = { "/VO/ZagreusField_2702" } },
				-- Have to say, the Barge of Death is never late.
				{ Cue = "/VO/ZagreusField_2700", RequireCurrentEncounterCompleted = true,     RequiredPlayed = { "/VO/ZagreusField_2702" } },
				-- Ready when you are, Barge of Death.
				{ Cue = "/VO/ZagreusField_2701", RequireCurrentEncounterCompleted = true,     RequiredPlayed = { "/VO/ZagreusField_2702" } },
				-- Why it's the Barge of Death.
				{ Cue = "/VO/ZagreusField_2702" },
				-- Barge of Death, you're here!
				{ Cue = "/VO/ZagreusField_2703", RequireCurrentEncounterCompleted = true,     RequiredPlayed = { "/VO/ZagreusField_2702" } },
				...
				InteractTextLineSets =
				{
					B_MiniBoss02_FirstInspect =
					{
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}The act of sorcery often ends in an untimely death and an eternity in Tartarus for careless souls, though some are able to perfect the trade, and take up permanent residence elsewhere..."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_B_Shop_01_01 =
					{
						...
						EndWait = 0.3,
						{
							...
							Text =
							"{#DialogueItalicFormat}The searing flame and ashes of the river Phlegethon mean nothing to the ferryman, Charon, who travels all the waters of the Underworld, bearing the dead, the damned, and all their fineries."
						},
					},
				},
			},
	...
	X_Reprieve01 =
	{
				...
				InteractTextLineSets =
				{
					Inspect_B_Reprieve_01_01 =
					{
						...
						EndWait = 0.3,
						{
							...
							Text =
							"{#DialogueItalicFormat}Hidden well within the limitless inferno of the river Phlegethon, somehow, a trickle of life-giving water yet remains; as though provided by the Fates themselves unto the very lucky Prince."
						},
					},
				},
			},
		...
		{
			{
				TriggerObjectType = "HealthFountain",
				WithinDistance = 800,
				VoiceLines =
				{
					BreakIfPlayed = true,
				...
				InteractTextLineSets =
				{
					Inspect_B_Intro_01_01 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}The once-verdant plains of Asphodel are now engulfed in scintillating flame, having been flooded by the river Phlegethon, whose hideously superheated contents could bring death swiftly even to those resistant to most heat."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_B_Intro_02 =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}Within the suffocating heat of Asphodel reside the vast majority of those who lived upon the earth and died. There they persist until the end of time."
						},
					},
				},
			},
	...
	X_Story01 =
	{
				...
				InteractTextLineSets =
				{
					Inspect_B_Story_01_01 =
					{
						...
						EndWait = 0.4,
						{
							...
							Text =
							"{#DialogueItalicFormat}From within a humble residence in Asphodel reverberates the golden-sounding voice of lorn Eurydice, who once attempted to escape the Underworld, and failed, utterly, much like Prince Zagreus."
						},
					},
				},
			},
		...
		{
			{
				TriggerObjectType = "NPC_Eurydice_01",
				WithinDistance = 375,
