...
-- Load the RoomData from a file
local function LoadRoomData(fileName)
...
local roomSetDataTartarus = LoadRoomData("RoomDataTartarus.lua").Tartarus
local modifications = {
	BaseTartarus = {
...
--[[
game.RoomSetData.TartarusModsNikkelMHadesBiomes =
{
	BaseTartarus =
	{
		DebugOnly = true,

		-- TODO: Use Tartarus encounters
		LegalEncounters = game.EncounterSets.FEncountersDefault,
		...
		TrapOptions = game.EnemySets.TrapsBiome1,
		UsePromptOffsetX = 20,
