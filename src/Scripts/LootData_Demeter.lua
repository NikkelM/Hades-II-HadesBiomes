local newPortedInteractTextLines = {
	...
	},
	{
		...
		RequiredFalseTextLines = { "OlympianReunionQuestComplete" },
		{
			...
			UseEventEndSound = true,
			TriggerCooldowns = { "ZagreusBoonPickUpSpeech" },
			Text = "My daughter to a baseborn farm-boy, she... why, little sprout, I wasn't very kind to her, I think. Certainly not once her father passed. It was her mortal blood that made her weak! Born to mortals, taken by mortals, I suspect. So now, they {#DialogueItalicFormat}pay{#PreviousFormat}.",
		},
	},
	{
...
mod.AddNarrativeDataEntries(
	newPortedInteractTextLines, "DemeterUpgrade", "InteractTextLineSets", "InteractTextLinePriorities",
	{ Demeter = { "Modsnikkelmhadesbiomesdemeter", "ZagreusField" } }, { Demeter_ = "Modsnikkelmhadesbiomesdemeter_" },
...
mod.AddNarrativeDataEntries(
	newPortedLootBoughtTextLines, "DemeterUpgrade", "BoughtTextLines", "BoughtTextLinePriorities",
	{ Demeter = { "Modsnikkelmhadesbiomesdemeter" } }, { Demeter_ = "Modsnikkelmhadesbiomesdemeter_" },
	{ Demeter_ = "ModsNikkelMHadesBiomes_Portrait_Demeter_Default_01" }
)
...
mod.AddNarrativeDataEntries(
	newPortedRejectionTextLines, "DemeterUpgrade", "RejectionTextLines", nil,
	{ Demeter = { "Modsnikkelmhadesbiomesdemeter" } }, { Demeter_ = "Modsnikkelmhadesbiomesdemeter_" },
	{ Demeter_ = "ModsNikkelMHadesBiomes_Portrait_Demeter_Default_01" }
)
...
mod.AddNarrativeDataEntries(
	newPortedMakeUpTextLines, "DemeterUpgrade", "MakeUpTextLines", nil,
	{ Demeter = { "Modsnikkelmhadesbiomesdemeter" } }, { Demeter_ = "Modsnikkelmhadesbiomesdemeter_" },
	{ Demeter_ = "ModsNikkelMHadesBiomes_Portrait_Demeter_Default_01" }
)
