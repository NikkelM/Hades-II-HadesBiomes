...
mod.RoomData.Styx = mod.RoomData.Styx or {
	BaseStyx =
	{
		DebugOnly = true,
				...
				InteractTextLineSets =
				{
					Inspect_D_MiniBoss_02_01 =
					{
						...
						EndWait = 0.4,
						{
							...
							Text =
							"{#DialogueItalicFormat}Inside the filth-encrusted lairs carved into the looming edifices of the Underworld lie such terrible abominations that not even grim Lord Hades is inclined to speak of them."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_D_Reprieve_01_01 =
					{
						...
						EndWait = 0.5,
						{
							...
							Text =
							"{#DialogueItalicFormat}Deep within the desecrated lair of the god-defiling Satyrs lie the noisome contents of their profane rituals, so foul as to be indescribable."
						},
					},
				},
			},
	...
	D_Boss01 =
	{
		...
		EnterVoiceLines =
		{
			...
			},
			{
				...
				{ Cue = "/VO/ZagreusField_4525", RequiredTextLines = { "HadesGift05" },               PreLineWait = 5.0 },
				...
				InteractTextLineSets =
				{
					Inspect_D_Intro_01_01 =
					{
						...
						EndWait = 0.45,
						{
							...
							Text =
							"{#DialogueItalicFormat}At last the willful prince has ventured all the way up to the surface of the mortal realm, yet still he is encased within the earth itself: the gateway to the Underworld, a threshold from which there is no escape."
						},
					},
				},
			},
	...
	D_Hub =
	{
		...
		{
			{
				TriggerObjectType = "NPC_Cerberus_Field_01",
				WithinDistance = 1500,
				...
				InteractTextLineSets =
				{
					...
					Inspect_D_Hub_01 =
					{
						...
						EndWait = 0.5,
						{
							...
							Text =
							"{#DialogueItalicFormat}The vast Temple of Styx and its innumerable dangers now are all that separate the Underworld Prince from the land outside, which he so desperately longs to see."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					...
					Inspect_D_Hub_02 =
					{
						...
						EndWait = 0.5,
						{
							...
							Text =
							"{#DialogueItalicFormat}Not far from here, the dead begin their journey to their final resting-place down in the depths below; and so the river-boatman Charon often passes through."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					...
					Inspect_D_Hub_03 =
					{
						...
						EndWait = 0.5,
						{
							...
							Text =
							"{#DialogueItalicFormat}The widely-feared and many-headed Cerberus, the Underworld's sentinel, presides over the entrance to this realm, devouring whole those fool enough to make attempts to flee."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					...
					Inspect_D_Hub_04 =
					{
						...
						EndWait = 0.5,
						{
							...
							Text =
							"{#DialogueItalicFormat}A crudely-hewn network of tunnels grows from one of the cold Temple's flanks, containing vicious denizens unwelcome in this realm, even in death."
						},
					},
				},
			},
