...
mod.RoomData.Tartarus = {
	...
	A_PreBoss01 =
	{
		...
		-- TODO: Set to 0 to force as first room after RoomOpening
				...
				InteractTextLineSets =
				{
					A_PreBoss_01_FirstInspect =
					{
						...
						EndWait = 0.3,
						{
							...
							Text =
							"{#DialogueItalicFormat}Beyond the present chamber lies the outermost perimeter of Tartarus, promising terrifying dangers far beyond the Underworld Prince's reckoning."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					A_Boss_01_Inspect01 =
					{
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}The Erinyes; known also as the Furies, they are the trusted sentinels of Lord Hades, charged with torturing the worst of mortalkind... and ridding the Underworld of any fool enough to trespass where they do not belong."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					A_PostBoss_01_FirstInspect =
					{
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}The path from Tartarus is finally laid bare. Far above, the heat from Phlegethon, the river of flame, is faintly felt already... even as its dangers lie in wait."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					A_PostBoss_01_GearsInspect01 =
					{
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}None, other than those in the trusted inner circle of Lord Hades, are authorized to enter the intricate chambers connecting the vast regions of the Underworld; but the Prince decides to barge in, anyway."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					A_MiniBoss03_01_FirstInspect =
					{
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}The most violent wretches of Tartarus are sealed away even from other condemned souls; their only visitors, those fool enough to attempt escape."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					A_MiniBoss04_01_FirstInspect =
					{
						...
						},
						{
							...
							Text =
							"{#DialogueItalicFormat}Damned, lost souls with nowhere left to turn congregate in deepest Tartarus, where they fuse together with the earth itself into odious forms which defy description."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					A_Reprieve_01_FirstInspect =
					{
						...
						EndWait = 0.4,
						{
							...
							Text =
							"{#DialogueItalicFormat}A place of calm and respite, whilst perhaps unimaginable in the Underworld, occasionally is to be found, in fact."
						},
					},
				},
			},
	...
	A_Shop01 =
	{
				...
				InteractTextLineSets =
				{
					CharonFirstInspect =
					{
						...
						EndWait = 0.3,
						{
							...
							Text =
							"{#DialogueItalicFormat}The infernal wares of the stygian boatman, Charon, lie sprawled about, available for sale to whomever would be willing to quench the boatman's great thirst for riches."
						},
					},
				},
			},
		...
		{
			{
				TriggerObjectType = "NPC_Charon_01",
				WithinDistance = 1600,
				VoiceLines =
				{
					-- The gods were pleased with all his bravery.
					...
					{
						{
							...
							Text =
							"I have to tell you something, little Hades: My relatives and I, we've been holding back one of our greatest gifts!! To see if you were worthy. And you are! My aid is yours, so call me if you need anything! Especially to smash your enemies to bits."
						},
					},
				},
				...
				InteractTextLineSets =
				{
					OpeningFirstInspect =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}Composed of such innumerable ever-shifting interlocking chambers, the Underworld of Lord Hades all but guarantees the dead shall there remain until the end of time."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					OpeningProcGenHint =
					{
						...
						EndWait = 0.35,
						{
							...
							Text =
							"{#DialogueItalicFormat}Each time the Prince delves back into the Underworld, its ever-shifting chambers realign to frustrate his attempts to perhaps map it out."
						},
					},
				},
			},
				...
				InteractTextLineSets =
				{
					Inspect_A_Story_01_01 =
					{
						...
						EndWait = 0.3,
						{
							...
							Text =
							"{#DialogueItalicFormat}Within the depths of Tartarus reside the most wretched of all the shades who linger for eternity within the Underworld, whose Lord and Master is especially unkind to those attempting to cheat death."
						},
					},
				},
			},
