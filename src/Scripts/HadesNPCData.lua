...
mod.PresetEventArgs = mod.PresetEventArgs or {
	...
	SingingEurydiceSong01_Duet_SongFromStart = {
		TrackName = "{c0d14448-c68a-429d-b09b-b0e2a5247510}",
		Restore = true,
	},
...
mod.NPCData = mod.NPCData or {
	...
	-- Orpheus Reunited, Id = 554419
	NPC_Orpheus_Story_01 = {
		InheritFrom = { "NPC_Orpheus_01" },
		CanReceiveGift = false,
		TextLinesPauseAmbientMusicVocals = false,
		TextLinesPauseAmbientMusicVocals2 = false,
		PartnerObjectId = 514436,
		PartnerSingingAnimation = "EurydiceIdleSinging_Start",
		PartnerSingingFx = "StatusSinging_Eurydice",

		ActivateRequirements = {
			SuccessiveChanceToPlay = 0.75,
			RequiredTextLines = { "OrpheusAboutSingersReunionQuest01" },
			RequiredFalseTextLinesLastRun = { "OrpheusAboutSingersReunionQuest01" },
			MinRunsSinceAnyTextLines = { TextLines = GameData.OrpheusWithEurydiceTextLines, Count = 4 }
		},
		...
		InteractTextLineSets = {
			...
			OrpheusWithEurydice01 = {
				PlayOnce = true,
				SuperPriority = true,
				Partner = "NPC_Eurydice_01",
				RequiredTextLines = { "OrpheusAboutSingersReunionQuest01" },
				RequiredFalseTextLinesLastRun = { "OrpheusAboutSingersReunionQuest01" },
				UseableOffSource = true,
				TextLinesPauseAmbientMusicVocals2 = true,
				AngleId = 514436,
				AngleTowardTargetId = 521169,
				-- UseText = "UseListenNPC",
				{
					Cue = "/VO/Orpheus_0145",
					SetFlagFalse = "OrpheusReunionInProgress",
					Text =
					"Why, Zagreus, how wonderful to see you here. Eurydice and I, we have been catching up for all the time we've spent apart."
				},
				{
					Cue = "/VO/Eurydice_0095",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydice02 = {
				...
				{
					Cue = "/VO/Orpheus_0150",
					Text = "Why, you're correct of course, my dear. If you'll excuse us, Zagreus? Our calling beckons."
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydice03 = {
				...
				SuperPriority = true,
				Partner = "NPC_Eurydice_01",
				RequiredTextLines = { "OrpheusWithEurydice02" },
				UseableOffSource = true,
				TextLinesPauseAmbientMusicVocals2 = true,
				AngleId = 514436,
				AngleTowardTargetId = 521169,
				-- UseText = "UseListenNPC"
				{
					...
					PostLineAnim = "ZagreusTalkEmpathy_Return",
					PostLineAnimTarget = "Hero",
					Text = "Hey, you two, how's everything lately? On speaking terms again? Or singing terms?"
				},
				{
					Cue = "/VO/Orpheus_0146",
					Text = "Oh, things are going very wonderfully, my friend. I never thought I'd see Eurydice again, after I..."
				},
				{
					Cue = "/VO/Eurydice_0096",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
					Text =
			...
			OrpheusWithEurydiceEndTheme01 = {
				...
				SuperPriority = true,
				Partner = "NPC_Eurydice_01",
				RequiredTextLines = { "OrpheusWithEurydice01", "OrpheusPostEnding01" },
				UseableOffSource = true,
				TextLinesPauseAmbientMusicVocals = true,
				AngleId = 514436,
				AngleTowardTargetId = 521169,
				-- UseText = "UseListenNPC",
				{
					...
					PostLineAnimTarget = "Hero",
					Text =
					"Hey, you're singing {#DialogueItalicFormat}In the Blood {#PreviousFormat}after all, Orpheus! Thank you for taking my request!"
				},
				{
					Cue = "/VO/Orpheus_0234",
					Text =
		...
		RepeatableTextLineSets = {
			OrpheusWithEurydiceMiscChat01 = {
				...
				UseableOffSource = true,
				TextLinesPauseAmbientMusicVocals2 = true,
				StartPartnerTextLinesAnimation = "EurydiceIdleSinging_SingingLoop_End",
				EndPartnerTextLinesAnimation = "EurydiceIdleSinging_Start",
				AngleId = 514436,
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0033",
					Text = "Hey, nice of you to visit us, Your Royal Majesty! For you!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat02 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0034",
					Text = "Orphy and I, we're doing great here thanks to you. You take care, hon!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat03 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0035",
					Text = "Hope you find yourself someone to sing with, too, hon.",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat04 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0036",
					Text = "Don't fret, Your Majesty, I'll have him back to work on time, you hear that, Orphy?",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat05 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0037",
					Text = "Orphy and me, we're like your typical old married couple, hon.",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat07 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0039",
					Text = "Things aren't so bad here, hon. Hope you can say the same.",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat08 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0040",
					Text = "What can I say, hon? We like practicing our favorite tune!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat09 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0041",
					Text = "Well if it isn't the Hades kid come to pay the both of us a visit!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat10 = {
				...
				AngleId = 514436,
				AngleTowardTargetId = 521169,
				RequiredMinAnyTextLines = { TextLines = { "OrpheusWithEurydiceMiscChat01", "OrpheusWithEurydiceMiscChat02", "OrpheusWithEurydiceMiscChat03", "OrpheusWithEurydiceMiscChat04", "OrpheusWithEurydiceMiscChat05", "OrpheusWithEurydiceMiscChat06", "OrpheusWithEurydiceMiscChat07", "OrpheusWithEurydiceMiscChat08", "OrpheusWithEurydiceMiscChat09" }, Count = 4 },
				{
					Cue = "/VO/Orpheus_0249",
					PreLineWait = 0.35,
					Text = "...You must know, you sound as wonderful as ever, now, my dear!",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat11 = {
				...
				{
					Cue = "/VO/Orpheus_0250",
					Text = "Is she not truly wonderful, my friend?",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat12 = {
				...
				{
					Cue = "/VO/Orpheus_0251",
					Text = "We sing, and sing, and never once grow weary, Zagreus!",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat13 = {
				...
				{
					Cue = "/VO/Orpheus_0252",
					Text = "I never thought I would see her again. You are to thank for this, my friend.",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat14 = {
				...
				{
					Cue = "/VO/Orpheus_0253",
					Text = "When we thus sing together, Zagreus, I lose all track of time.",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat15 = {
				...
				{
					Cue = "/VO/Orpheus_0254",
					Text = "Is the singing of Eurydice not the most splendid thing that you have ever heard?",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat16 = {
				...
				{
					Cue = "/VO/Orpheus_0255",
					Text = "Shall there ever be a voice as lovely as Eurydice's, my friend?",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat17 = {
				...
				{
					Cue = "/VO/Orpheus_0256",
					Text = "It gladdens me that you could join us here, my friend.",
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceMiscChat18 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0248",
					Text = "Guess what we've been up to lately, hon? Now if you'll excuse us?",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat19 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0249",
					Text = "We just finished eating, here! Got plenty left over.",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat20 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0250",
					Text = "The one thing better than singing, hon, is singing with somebody you love.",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat21 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0251",
					Text = "Orphy here's just practicing for when he's got to sing next for Hades Senior!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat22 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0252",
					Text = "What do you know, we were just in the middle of a song here, hon!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat23 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0253",
					Text = "Not much luck trying to teach Orphy to cook, but he can sing, all right!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat24 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0254",
					Text = "Look, Orphy, we've got an audience! So sing your heart out!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceMiscChat25 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0255",
					Text = "Don't mind Orphy, here, hon. Can't snap him out of it once he gets singing!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceInTheBloodChat01 = {
				PlayOnce = true,
				Partner = "NPC_Eurydice_01",
				RequiredTextLines = { "OrpheusWithEurydiceEndTheme01" },
				StatusAnimation = false,
				UseableOffSource = true,
				TextLinesPauseAmbientMusicVocals2 = true,
				StartPartnerTextLinesAnimation = "EurydiceIdleSinging_SingingLoop_End",
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0209",
					Text = "You know this tune, hon? It's one of our old hits!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceInTheBloodChat02 = {
				Partner = "NPC_Eurydice_01",
				RequiredTextLines = { "OrpheusWithEurydiceInTheBloodChat01" },
				StatusAnimation = false,
				UseableOffSource = true,
				TextLinesPauseAmbientMusicVocals2 = true,
				StartPartnerTextLinesAnimation = "EurydiceIdleSinging_SingingLoop_End",
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0210",
					Text = "We were just thinking about old times, Orphy and I!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceInTheBloodChat03 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0211",
					Text = "Thought we'd mix up our singing just a bit here, hon!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceInTheBloodChat04 = {
				...
				AngleTowardTargetId = 521169,
				{
					Cue = "/VO/Eurydice_0212",
					Text = "Got to tell you I've warmed up to this old song over the years!",
					Portrait = "Portrait_Eurydice_Default_01",
					Speaker = "NPC_Eurydice_01",
				},
				{
			...
			OrpheusWithEurydiceInTheBloodChat05 = {
				...
				{
					Cue = "/VO/Orpheus_0261",
					Text = "I know that you enjoy this one, my friend!"
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceInTheBloodChat06 = {
				...
				{
					Cue = "/VO/Orpheus_0262",
					Text = "This one reminds me of my days alive with my Eurydice...!"
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
			...
			OrpheusWithEurydiceInTheBloodChat07 = {
				...
				{
					Cue = "/VO/Orpheus_0263",
					Text = "This song had quite a bit of popularity, one time."
				},
				{
					Text = "Eurydice_OfferText03",
					Portrait = "Portrait_Eurydice_Default_01",
