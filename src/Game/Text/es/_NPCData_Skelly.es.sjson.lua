...
local newData = {
  ...
  -- --  DisplayName = "Si las pasas canutas ahí fuera, recuerda una cosa. Eres un dios, ¿vale? Muchísimo más fuerte de lo que piensas. Si te dan para el pelo, activa el Modo Dios y enséñales lo que vale un peine."
	-- 	DisplayName =
	...
	-- 	InheritFrom = "BaseNarrative",
  -- --  DisplayName = "Lo dices como si ese Modo Dios fuera una palanca que pudiese accionar a voluntad para liberar mi fuerza latente."
	-- 	DisplayName =
