local hadesCodexTextFile = rom.path.combine(mod.hadesGameFolder, "Content\\Game\\Text\\es\\CodexText.es.sjson")
...
local screenTextFile = rom.path.combine(rom.paths.Content(), 'Game\\Text\\es\\HelpTextHades.es.sjson')
