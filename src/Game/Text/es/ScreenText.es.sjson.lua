...
local newData = {
	...
	-- #region Relationship/Unlock hints
	{
		...
		DisplayName =
		"\\n {#CodexStandardFormat}{!Icons.CodexEntryIncompleteIcon}  {#CodexChapterClearFormat} Afianza tu relación con {$TempTextData.Name}{#CodexStandardFormat} para saber más",
	},
	-- {
	...
	{
		Id = "Meg_GoToHer",
		DisplayName = "{CF} Acercarte a ella",
	},
	{
		Id = "Meg_BackOff",
		DisplayName = "{CN} Rechazar",
	},
	{
		Id = "Than_GoToHim",
		DisplayName = "{CF} Consolarlo",
	},
	{
		Id = "Than_BackOff",
		DisplayName = "{CN} Rechazar",
	...
	{
		Id = "Dusa_Accept",
		DisplayName = "{CF} Aceptar educadamente",
	},
	{
		Id = "Dusa_Decline",
		DisplayName = "{CN} Rechazar amablemente",
	},
	{
		Id = "MegThan_GoToThem",
		DisplayName = "{CF} Aceptar",
	},
	{
		Id = "MegThan_BackOff",
		DisplayName = "{CN} Rechazar",
	...
	-- 	DisplayName = "Installation failed!",
	-- 	Description =
	-- 	"Welcome to {#DialogLegendaryFormat}Zagreus\' Journey{#Prev}!\n\nUnfortunately, installing the mod has {#DialogLegendaryFormat}FAILED{#Prev}, or your existing installation is broken, because the mod {#DialogLegendaryFormat}could not copy all of its files{#Prev}.\nMake sure your mod manager\'s {#DialogLegendaryFormat}profile folder {#Prev}is not {#DialogLegendaryFormat}read-only{#Prev}, then reinstall the mod. Files may also be missing from Hades - check the {#DialogLegendaryFormat}hadesGameFolder {#Prev}setting and verify your game files.\n\nIf the issue persists, please start a discussion on\n{#ItalicFormat}github.com/NikkelM/Hades-II-HadesBiomes/discussions{#Prev}\nand attach the log file from {#DialogLegendaryFormat}Settings -> Copy log file {#Prev}in your mod manager.",
	-- },
	-- {
	...
	-- #region WeaponUpgrade (Silver Pool/Aspect selection) stats screen
	{
		...
		DisplayName = "{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Victoria más rápida:",
	},
	{
		Id = "WeaponUpgradeScreen_ShrinePointRecord_ModsNikkelMHadesBiomesModdedRoute",
		DisplayName =
		"{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} {!Icons.ShrinePoint}{#BoldFormatGraft}Miedo {#Prev}más alto:",
	},
	-- #endregion
	...
	-- #region Dream Run result texts for run history screen
	{
		...
		DisplayName = "Fracaso en {#RunHistoryFailureFormat}TÁRTARO?{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Asphodel_Dream",
		DisplayName = "Fracaso en {#RunHistoryFailureFormat}ASFÓDELOS?{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Elysium_Dream",
		DisplayName = "Fracaso en {#RunHistoryFailureFormat}ELÍSEO?{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Styx_Dream",
		DisplayName = "Fracaso en {#RunHistoryFailureFormat}ESTIGIA?{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Erebus_Dream",
		DisplayName = "Fracaso en {#RunHistoryFailureFormat}ÉREBO?{#Prev}",
	},
	-- #endregion
}
