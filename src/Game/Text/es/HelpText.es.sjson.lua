...
local newData = {
	...
	},
	{
		...
		DisplayName = "{I} {#UseTextPreReqFormat}Marcharte{#Prev}\n {RR} {#UseTextPreReqFormat}Avanzar",
	},
	...
	},
	{
		...
		DisplayName = "El TEMPLO del ESTIGIA?",
	},
	{
	...
	-- 	DisplayName = "{#TeamFormat}Foes Slain by {#Prev}{#TeamThanFormat}Visage of Thanatos{#Prev}: {$ThanatosKills}",
	-- },
	-- #endregion
	-- #endregion
