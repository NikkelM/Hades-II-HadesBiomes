...
local newData = {
  ...
  -- --  DisplayName = "애송이, 다음 번에 힘든 상황에 처하게 되면 이걸 기억하라고. 넌 신이야, 알겠냐?! 넌 네 생각보다 훨씬 강해. 너무 어려우면 신 모드를 켜라고. 그러면 적들을 뼈째로 씹어먹을 수 있을 거야!"
	-- 	DisplayName =
	...
	-- 	InheritFrom = "BaseNarrative",
  -- --  DisplayName = "내가 마음만 먹으면 신 모드를 손바닥 뒤집듯이 쉽게 작동시킬 수 있다는 듯이 말하는군."
	-- 	DisplayName =
