...
local newData = {
	...
	-- #region Relationship/Unlock hints
	{
		...
		DisplayName =
		"\\n {#CodexStandardFormat}{!Icons.CodexEntryIncompleteIcon}  {#CodexChapterClearFormat} Saiba Mais Melhorando Seu Relacionamento Com {$TempTextData.Name}{#CodexStandardFormat}",
	},
	-- {
	...
	{
		Id = "Meg_GoToHer",
		DisplayName = "{CF} Ir Até Ela",
	},
	{
		Id = "Meg_BackOff",
		DisplayName = "{CN} Recusar",
	},
	{
		Id = "Than_GoToHim",
		DisplayName = "{CF} Confortá-lo",
	},
	{
		Id = "Than_BackOff",
		DisplayName = "{CN} Recusar",
	...
	{
		Id = "Dusa_Accept",
		DisplayName = "{CF} Aceitar Educadamente",
	},
	{
		Id = "Dusa_Decline",
		DisplayName = "{CN} Recusar Gentilmente",
	},
	{
		Id = "MegThan_GoToThem",
		DisplayName = "{CF} Ir até Eles",
	},
	{
		Id = "MegThan_BackOff",
		DisplayName = "{CN} Recusar",
	...
	-- #region WeaponUpgrade (Silver Pool/Aspect selection) stats screen
	{
		...
		DisplayName = "{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Vitória mais rápida:",
	},
	{
		Id = "WeaponUpgradeScreen_ShrinePointRecord_ModsNikkelMHadesBiomesModdedRoute",
		DisplayName =
		"{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Maior {!Icons.ShrinePoint}{#BoldFormatGraft}medo{#Prev}:",
	},
	-- #endregion
