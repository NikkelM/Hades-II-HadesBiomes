...
local newData = {
	...
	-- },
	{
		...
		DisplayName = "{I} Embarcar \n {RR} Alterar {#UseGiftPointFormat}(-1{!Icons.ReRoll})",
	},
	{
		Id = "ModsNikkelMHadesBiomes_UseFinalBossDoorWithSurface",
		DisplayName = "{I} {#UseTextPreReqFormat}Sair{#Prev}\n {RR} {#UseTextPreReqFormat}Avançar",
	},
	-- #region Badge Ranks/Spirit Mixer
	{
		Id = "BadgeSeller_UseTextTalkAndGift_Both",
		DisplayName =
		"{I} Proclamar {#UseGiftPointFormat}({$TempTextData.ResourceAmount1}{!TempTextData.ResourceIconPath1} {$TempTextData.ResourceAmount2}{!TempTextData.ResourceIconPath2})\n {G} Avançar {#UseGiftPointFormat}({$TempTextData.ModsNikkelMHadesBiomesResourceAmount1}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath1} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount2}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath2} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount3}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath3})",
	},
	{
	...
	},
	{
		...
		DisplayName =
		"{I} Proclamar {#ShopCostCantAffordFormat}({$TempTextData.ResourceAmount1}{!TempTextData.ResourceIconPath1} {$TempTextData.ResourceAmount2}{!TempTextData.ResourceIconPath2})\n {G} Avançar {#UseGiftPointFormat}({$TempTextData.ModsNikkelMHadesBiomesResourceAmount1}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath1} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount2}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath2} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount3}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath3})",
	},
	{
	...
	},
	{
		...
		DisplayName =
		"{I} Proclamar {#UseGiftPointFormat}({$TempTextData.ResourceAmount1}{!TempTextData.ResourceIconPath1} {$TempTextData.ResourceAmount2}{!TempTextData.ResourceIconPath2})\n {G} Avançar {#ShopCostCantAffordFormat}({$TempTextData.ModsNikkelMHadesBiomesResourceAmount1}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath1} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount2}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath2} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount3}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath3})",
	},
	{
	...
	-- #region UI
	{
		...
		DisplayName = "Sobreviver por: {$RemainingSeconds} Seg.",
	},
	-- {
	...
	},
	{
		...
		DisplayName = "O TEMPLO de ESTIGE?",
	},
	{
