...
local newData = {
	...
	-- #region Relationship/Unlock hints
	{
		...
		DisplayName =
		"\\n {#CodexStandardFormat}{!Icons.CodexEntryIncompleteIcon}  {#CodexChapterClearFormat} Dowiedz Się Więcej Pogłębiając Relację Z: {$TempTextData.Name}{#CodexStandardFormat}",
	},
	-- {
	...
	{
		Id = "Meg_GoToHer",
		DisplayName = "{CF} Idź do niej",
	},
	{
		Id = "Meg_BackOff",
		DisplayName = "{CN} Odpuść",
	},
	{
		Id = "Than_GoToHim",
		DisplayName = "{CF} Pociesz go",
	},
	{
		Id = "Than_BackOff",
		DisplayName = "{CN} Odpuść",
	...
	{
		Id = "Dusa_Accept",
		DisplayName = "{CF} Grzecznie akceptuj",
	},
	{
		Id = "Dusa_Decline",
		DisplayName = "{CN} Uprzejmie odmów",
	},
	{
		Id = "MegThan_GoToThem",
		DisplayName = "{CF} Idź do Nich",
	},
	{
		Id = "MegThan_BackOff",
		DisplayName = "{CN} Odpuść",
	...
	-- #region WeaponUpgrade (Silver Pool/Aspect selection) stats screen
	{
		...
		DisplayName = "{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Najlepszy czas:",
	},
	{
		Id = "WeaponUpgradeScreen_ShrinePointRecord_ModsNikkelMHadesBiomesModdedRoute",
		DisplayName =
		"{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Najwyższy poz. {!Icons.ShrinePoint}{#BoldFormatGraft}Strachu{#Prev}:",
	},
	-- #endregion
