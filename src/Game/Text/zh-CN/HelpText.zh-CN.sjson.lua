...
local newData = {
	...
	-- },
	{
		...
		DisplayName = "{I} 上船 \n {RR} 重置 {#UseGiftPointFormat}(-1{!Icons.ReRoll})",
	},
	-- #region Badge Ranks/Spirit Mixer
	{
		Id = "BadgeSeller_UseTextTalkAndGift_Both",
		DisplayName =
		"{I} 宣告 {#UseGiftPointFormat}({$TempTextData.ResourceAmount1}{!TempTextData.ResourceIconPath1} {$TempTextData.ResourceAmount2}{!TempTextData.ResourceIconPath2})\n {G} 升级 {#UseGiftPointFormat}({$TempTextData.ModsNikkelMHadesBiomesResourceAmount1}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath1} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount2}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath2} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount3}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath3})",
	},
	{
	...
	},
	{
		...
		DisplayName =
		"{I} 宣告 {#ShopCostCantAffordFormat}({$TempTextData.ResourceAmount1}{!TempTextData.ResourceIconPath1} {$TempTextData.ResourceAmount2}{!TempTextData.ResourceIconPath2})\n {G} 升级 {#UseGiftPointFormat}({$TempTextData.ModsNikkelMHadesBiomesResourceAmount1}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath1} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount2}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath2} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount3}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath3})",
	},
	{
	...
	},
	{
		...
		DisplayName =
		"{I} 宣告 {#UseGiftPointFormat}({$TempTextData.ResourceAmount1}{!TempTextData.ResourceIconPath1} {$TempTextData.ResourceAmount2}{!TempTextData.ResourceIconPath2})\n {G} 升级 {#ShopCostCantAffordFormat}({$TempTextData.ModsNikkelMHadesBiomesResourceAmount1}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath1} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount2}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath2} {$TempTextData.ModsNikkelMHadesBiomesResourceAmount3}{!TempTextData.ModsNikkelMHadesBiomesResourceIconPath3})",
	},
	{
	...
	-- #region UI
	{
		...
		DisplayName = "坚持存活：{$RemainingSeconds}秒",
	},
	-- {
	...
	},
	{
		...
		DisplayName = "倒在了{#RunHistoryFailureFormat}{$RoomSetData.Tartarus.BaseTartarus.DreamSaveProfileLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Asphodel_Dream",
		DisplayName = "倒在了{#RunHistoryFailureFormat}{$RoomSetData.Asphodel.BaseAsphodel.DreamSaveProfileLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Elysium_Dream",
		DisplayName = "倒在了{#RunHistoryFailureFormat}{$RoomSetData.Elysium.BaseElysium.DreamSaveProfileLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Styx_Dream",
		DisplayName = "倒在了{#RunHistoryFailureFormat}{$RoomSetData.Styx.BaseStyx.DreamSaveProfileLocationText}{#Prev}",
	},
	-- #endregion
