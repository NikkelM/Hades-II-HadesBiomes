...
local newData = {
	...
	-- #region Dream Run result texts for run history screen
	{
		...
		DisplayName =
		"Поражение в {#RunHistoryFailureFormat}[Тартаре (во сне)]{$RoomSetData.Tartarus.BaseTartarus.DreamLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Asphodel_Dream",
		DisplayName =
		"Поражение на {#RunHistoryFailureFormat}[Асфоделе (во сне)]{$RoomSetData.Asphodel.BaseAsphodel.DreamLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Elysium_Dream",
		DisplayName =
		"Поражение в {#RunHistoryFailureFormat}[Элизиуме (во сне)]{$RoomSetData.Elysium.BaseElysium.DreamLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Styx_Dream",
		DisplayName =
		"Поражение на {#RunHistoryFailureFormat}[Стиксе (во сне)]{$RoomSetData.Styx.BaseStyx.DreamLocationText}{#Prev}",
	},
	{
		Id = "ModsNikkelMHadesBiomesRunHistoryScreenResult_Erebus_Dream",
		DisplayName =
		"Поражение в {#RunHistoryFailureFormat}[Эребе (во сне)]{$RoomSetData.Challenge.RoomChallenge01.DreamLocationText}{#Prev}",
	},
	-- #endregion
}
