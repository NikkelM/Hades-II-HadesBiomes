...
local newData = {
  ...
  -- --  DisplayName = "Wenn dir da draußen übel mitgespielt wird, Bursche, denk dran: Du bist ein Gott, hörst du?! Viel zäher, als du denkst. Wenn dir wer Ärger macht, schaltest du einfach in den Götter-Modus und zeigst es ihnen!"
	-- 	DisplayName =
	...
	-- 	InheritFrom = "BaseNarrative",
  -- --  DisplayName = "Du tust so, als sei dieser Götter-Modus eine Art Hebel, den ich einfach nach Belieben umlegen kann, wenn ich meine verborgenen Kräfte freisetzen will, Kumpel."
	-- 	DisplayName =
