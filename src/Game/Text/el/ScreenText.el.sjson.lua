...
local newData = {
	...
	-- #region WeaponUpgrade (Silver Pool/Aspect selection) stats screen
	{
		...
		DisplayName = "{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Γρηγορότερη νίκη:",
	},
	{
		Id = "WeaponUpgradeScreen_ShrinePointRecord_ModsNikkelMHadesBiomesModdedRoute",
		DisplayName =
		"{!Icons.ModsNikkelMHadesBiomesRunHistoryDoor} Υψηλότερος {!Icons.ShrinePoint}{#BoldFormatGraft}Φόβος{#Prev}:",
	},
	-- #endregion
