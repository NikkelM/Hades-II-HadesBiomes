...
local codexTextFile = rom.path.combine(rom.paths.Content(), "Game/Text/zh-TW/CodexText.zh-TW.sjson")
...
local newData = {
	Texts = {
		...
		-- 	DisplayName =
		-- 	"'...If the dead excel at anything, it is having to wait. It is the first thing almost all the dead must do, upon arriving at the edges of this realm. Erebus, their waiting area, lies shrouded in darkness, betraying to the dead no hint of whether they shall continue their existence in the splendors of Elysium or in the pits of Tartarus. {#CodexBoldFormat}Some wretched souls, for a variety of reasons, remain in Erebus indefinitely. For these, the Master sometimes offers a condition of reprieve: to do his bidding, or to wait, and wait, and wait awhile longer.{#Prev}'",
		-- },
		-- {
		...
		-- 	DisplayName =
		-- 	"'...What is there to say about the Master? Master not just of the House in which I work, but of the entirety of the domain beneath the earth, the place we all end up after we die. He is a god of character, I have to give him that. In life, I once served someone who reminded me of him a little, yet even the kingliest of mortals pales in comparison. Suffice it, then, to say that the Lord Hades takes matters of his Fate-appointed Underworld in utmost seriousness. {#CodexBoldFormat}Yet, his meticulous veneer gives way to impatience frequently enough, especially with his only son. This resentment extends to his never-ending work, for he presides over an endless procession of the dead. The Master claims he alone can tend to their affairs, but grudgingly, I think, expects his son's support...{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_Hades_04",
		-- 	DisplayName =
		-- 	"'...What is there to say about the Master? Master not just of the House in which I work, but of the entirety of the domain beneath the earth, the place we all end up after we die. He is a god of character, I have to give him that. In life, I once served someone who reminded me of him a little, yet even the kingliest of mortals pales in comparison. Suffice it, then, to say that the Lord Hades takes matters of his Fate-appointed Underworld in utmost seriousness. Yet, his meticulous veneer gives way to impatience frequently enough, especially with his only son. This resentment extends to his never-ending work, for he presides over an endless procession of the dead. The Master claims he alone can tend to their affairs, but grudgingly, I think, expects his son's support. {#CodexBoldFormat}After all, Lord Hades long since severed ties with his family on Olympus, and leads a solitary life, now. His son is his sole remaining connection to his family, and I fear it falters.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0011",
		-- 	DisplayName =
		...
		-- 	Id = "CodexData_0015",
		-- 	DisplayName =
		-- 	"'...It is said that Sleep is the cousin of Death. That turns out to be not quite correct, insofar as the two, in fact, are brothers, born to Nyx herself. The former of the two, we call him Hypnos; he whiles away, half-sleeping, watching over the Pool of Styx in the foyer of the House, taking stock of those arriving in the Master's domain, or returning to it. {#CodexBoldFormat}Though Hypnos may be lacking in propriety, he brings a certain cheer, however unconventional, into the grim proceedings of the House...{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0016",
		-- 	DisplayName =
		-- 	"'...It is said that Sleep is the cousin of Death. That turns out to be not quite correct, insofar as the two, in fact, are brothers, born to Nyx herself. The former of the two, we call him Hypnos; he whiles away, half-sleeping, watching over the Pool of Styx in the foyer of the House, taking stock of those arriving in the Master's domain, or returning to it. Though Hypnos may be lacking in propriety, he brings a certain cheer, however unconventional, into the grim proceedings of the House. {#CodexBoldFormat}It is a wonder that the Master is so tolerant of this. Some say it is because the Master is oblivious to Hypnos, but it is my choice to think the Master secretly and silently enjoys the bit of levity the fellow purposely or inadvertently provides.{#Prev}'",
		-- },
		-- {
		...
		-- 	DisplayName =
		-- 	"'...Few gods traverse the boundary that divides the surface realm where dwell the living, and this one, where dwell the dead. Thanatos ranks high even among those of such authority and power. Although it is my Master who presides over the Underworld, Thanatos is death itself, brother of Sleep, an instrument for sending mortals to the Underworld; more peacefully than violently, mind you, as I did not encounter him myself when came my time, by Ares' and Apollo's design. {#CodexBoldFormat}As death is swift and unavoidable to mortals, so is Thanatos devoted without question to his work. Fatherless, he honors always his mother, the goddess Nyx. He tirelessly serves his foreign Master, whose son at least he adores, despite their differences in manner and outlook...{#Prev}'",
		-- },
		-- {
		...
		-- 	DisplayName =
		-- 	"'...Mortality and immortality are closer than most gods care to believe. There are such minor gods as can be killed. So it is with nymphs, and all the naiads and the dryads and the like, the spirits of the woods, and seas, and skies; in life, they captivate our mortal senses and imaginations, but in death, we all are more alike. The nymph Eurydice, born of the oak itself, must know this better than most of her kind. She took a suitor who, by most accounts, was but a common mortal; talented beyond compare, but not a god. Yet, all the love they shared could not keep death from tearing them apart. She bears a special mention here for having almost fled the Underworld, once. Such was the full-hearted devotion of her mate, that he did venture all the way into this realm, in search of her, and treated with the Master for her soul. They say the Master almost let her go. {#CodexBoldFormat}But when he finally refused, she grieved, but she did not despair. Even in death, she moved on with her life.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0047",
		-- 	DisplayName =
		...
		-- 	DisplayName =
		-- 	"'...In the Underworld, as on the surface, certain topics are never to be discussed, especially in decent company. Well, this is not a discussion, and the company I keep is rather limited. So, let us consider the Queen of the Underworld; who she was, what happened to her, and why nobody seems to know the answer to either of those questions. All matters in the House of Hades are concealed from the living, and the gods above; even here, the one piece of agreed-upon knowledge concerning the Queen is the unspeakable punishment for invoking her name. {#CodexBoldFormat}I gather that her reign must have been short-lived, for there was not even a trace of her in the House. Save for one remnant I once thought I saw...{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_Persephone_04",
		-- 	DisplayName =
		-- 	"'...In the Underworld, as on the surface, certain topics are never to be discussed, especially in decent company. Well, this is not a discussion, and the company I keep is rather limited. So, let us consider the Queen of the Underworld; who she was, what happened to her, and why nobody seems to know the answer to either of those questions. All matters in the House of Hades are concealed from the living, and the gods above; even here, the one piece of agreed-upon knowledge concerning the Queen is the unspeakable punishment for invoking her name. I gather that her reign must have been short-lived, for there was not even a trace of her in the House. Save for one remnant I once thought I saw. {#CodexBoldFormat}It was something I was never meant to see. One day or perhaps night, I was guarding the Master's hall, when he threw open his private chamber doors in a fury. Then I saw her! A splendid portrait I have longed to see again since. What of the Master, then?{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0050",
		-- 	DisplayName =
		...
		-- 	Id = "CodexData_0066",
		-- 	DisplayName =
		-- 	"'...This is the land of death; anything that lives is likely to be rather bothersome, here, and the Numbskulls certainly fit this profile. {#CodexBoldFormat}Voracious little creatures, the Lord Hades nonetheless opted not to exterminate them all since they do have a tendency to prey on foolish shades who dare to leave their station.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0067",
		-- 	DisplayName =
		...
		-- 	Id = "CodexData_0068",
		-- 	DisplayName =
		-- 	"'...The hideous appearance of this mound of human-looking skulls effectively deters any who wander out into the reaches of the Underworld. {#CodexBoldFormat}Within, an endless litany of Numbskulls waits to clatter forth, mindlessly preying on what little life-essence that they are like to find.{#Prev}'",
		-- },
		-- {
		...
		-- 	Id = "CodexData_0072",
		-- 	DisplayName =
		-- 	"'...Practitioners of foul arts, their lives inevitably were cut short, but now continue in a way within the bowels of the earth. {#CodexBoldFormat}Here, the sole remaining source of purpose that they have is to snuff out the final vestiges of life that find their way into this grim domain.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0073",
		-- 	DisplayName =
		...
		-- 	Id = "CodexData_0074",
		-- 	DisplayName =
		-- 	"'...There is ample room in Tartarus even for these prodigious, boorish entities, who doubtless were intolerable even when they lived. {#CodexBoldFormat}Now, having been reduced merely to their most base of negative impulses, these damnable wretches do their part to help uphold the Underworld's cruel reputation.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0075",
		-- 	DisplayName =
		...
		-- 	DisplayName =
		-- 	"'...For mortals, the need occasionally arises to draw blood, whether for a cause or by necessity. But there are also those who do it for its own sake; monsters in the form of men, revealed finally for what they are once in this realm. {#CodexBoldFormat}By all rights, they should be sealed away in Tartarus. But their savagery is such that it draws the Master's attention, and some are able to secure a bit of reprieve in Asphodel, in exchange for enforcing the Master's will.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0084",
		-- 	DisplayName =
		...
		-- 	Id = "CodexData_0085",
		-- 	DisplayName =
		-- 	"'...One-time scions of so many long-forgotten cults, which worshiped monsters slain by heroes at some point, these remnants of the living yet possess capacity to give a certain shape to diabolic energies. {#CodexBoldFormat}Within these waves of devastation lie their memories of their hate-filled transgressions, which they re-live and re-create again and again, much like the ocean's wave lapping somewhere against brittle and uncaring shores.{#Prev}'",
		-- },
		-- {
		...
		-- 	DisplayName =
		-- 	"'...All mortal life is a struggle to survive that ends in failure; one final lesson, prior to a transfer here, where we have room enough for every living thing, from the greatest of men, to the lowliest of serpents. {#CodexBoldFormat}The Dracons of Asphodel seem to be remnants of the latter category, though are rarely seen for their shame-filled tendency to remain burrowed in their dens, rising up only when sufficiently agitated. Not so different from my kind, perhaps.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0086",
		-- 	DisplayName =
		-- 	"'...As if forged bronze is insufficient in its keen ability to put an end to life, there have been those who studied the eldritch art of chemistry to fashion devastating, fiery devices known as {#CodexItalicFormat}bombs{#Prev}...'",
		-- },
		-- {
		-- 	Id = "CodexData_0087",
		-- 	DisplayName =
		-- 	"'...As if forged bronze is insufficient in its keen ability to put an end to life, there have been those who studied the eldritch art of chemistry to fashion devastating, fiery devices known as {#CodexItalicFormat}bombs{#Prev}. {#CodexBoldFormat}They likely all fell victim to their own inventions. But even though they are now rightfully where they belong, their limitless desire for destruction yet keeps them intact.{#Prev}'",
		-- },
		-- {
		-- 	Id = "CodexData_0088",
		-- 	DisplayName =
		...
		-- 	Id = "CodexData_0097",
		-- 	DisplayName =
		-- 	"'...In the great and ancient war that raged between the Titans and Olympians, the brutish Cyclopes stood with the former side, and dearly paid for it. Their kind has all but disappeared from earth, though remnants still remain beneath it. {#CodexBoldFormat}Stripped of their cunning, some of their kind have been reduced only to one-eyed skulls, stacked somewhere like so many living trophies in the realm of the dead. There, they clamor for a chance to get back at the gods who made them thus.{#Prev}'",
		-- },
		-- {
		...
		-- 	Id = "CodexData_0127",
		-- 	DisplayName =
		-- 	"'...A multitude of worries decorate the brow of grim Lord Hades, whose nature is unknown to anyone but him. But, there are some concerns that even he cannot suppress. {#CodexBoldFormat}Take, for example, the dark movements of the satyr vermin-worshipers residing in the temple-gateway at the surface of this realm. What they must want is yet unclear; but, their hatred for Lord Hades is not. Efforts to exterminate the goat-faced fiends have proven unsuccessful to this point, for they reside frustratingly beyond even the Master's influence. What can they do, in turn, except to desecrate the Master's halls? Yet, if the Master is uneasy, there must be a cause.{#Prev}'",
		-- },
		-- #endregion
		...
		-- 	DisplayName =
		-- 	"'...When Mort first emerged from the darkness, he was frightened to discover he was on the smaller side of the variety of creatures that surrounded him. The world was such a dangerous place! However, Mother Night told him to take heart, and not to make too much about his size. It was not to his detriment, to be so small. Mort decided to put the idea to the test. {#CodexBoldFormat}He discovered there were creatures even smaller than he; insects, arachnids, and the like. And so he lorded over them, using his size to his advantage. When Mother Nyx found him, he was huddled in a corner, surrounded by tiny creatures thoroughly terrified of him. Since then, Mort still retains his odd ability to instill fear, though as protector of whomever he is given to, not as tormentor of the smallest things.{#Prev}'",
		-- },
		-- {
