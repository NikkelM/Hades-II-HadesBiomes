...
local configDesc = {
  ...
  uninstall =
  "[Deprecated - you should no longer need to use this] Set this to \"true\" and start the game to uninstall the mod, which removes files copied from your Hades installation. Do this before uninstalling or disabling the mod through r2modman to avoid loose files staying behind. To re-install, set both \"uninstall\" and \"firstTimeSetup\" to true. If \"firstTimeSetup\" is not also set to \"true\", \"enabled\" will be set to false after uninstalling.",
  hadesGameFolder =
