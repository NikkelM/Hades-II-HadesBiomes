...
<br>
After installing the mod, a Chaos Gate will appear in the Crossroads' Training Grounds, which will allow you to experience Zagreus' journey through the Underworld as Melinoë.
...
- Decorate the Crossroads with **50+** new cosmetics, including new **Cauldrons**, **Arcana Card Backs**, and **Charms** inspired by Zagreus' companions from the first game.
...
You _must_ have **Hades** installed on your system at all times when playing with this mod.
...
For more information or troubleshooting, see the [Installation wiki page](https://github.com/NikkelM/Hades-II-HadesBiomes/wiki/Installation-&-Uninstallation).
