...
SOURCE_DIRECTORY = 'ModsNikkelMHadesBiomesGUIModded_source'   # The directory to recursively search for images in
BASENAME = 'ModsNikkelMHadesBiomesGUIModded'           # Filenames created will start with this plus a number
